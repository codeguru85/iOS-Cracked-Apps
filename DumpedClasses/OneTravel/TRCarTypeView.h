...
@interface TRCarTypeView : UIView
{
    _Bool _isSelected;
...
@property(copy, nonatomic) NSString *carTypeId; // @synthesize carTypeId=_carTypeId;
...
- (void)createLines;
- (void)createSubViews;
- (id)initWithFrame:(struct CGRect)arg1 carType:(id)arg2 carTypeId:(id)arg3 carImageNameUnselected:(id)arg4 carImageNameSelected:(id)arg5;
