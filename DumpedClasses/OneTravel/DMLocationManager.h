...
@interface DMLocationManager : NSObject <CLLocationManagerDelegate>
{
    ...
    CLLocation *_curlocation4Orign;
}

+ (id)defaultManager;
+ (struct CLLocationCoordinate2D)wgs84Tochina:(struct CLLocationCoordinate2D)arg1;
@property(retain, nonatomic) CLLocation *curlocation4Orign; // @synthesize curlocation4Orign=_curlocation4Orign;
...
- (void)updateSimulationLocation:(id)arg1;
