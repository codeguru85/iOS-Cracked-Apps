...
@interface MapDataFile : PBGeneratedMessage <GeneratedMessageProtocol>
{
    unsigned int hasVersion_:1;
    unsigned int hasName_:1;
    unsigned int hasMd5_:1;
    unsigned int hasFilebody_:1;
    int version;
    NSString *name;
    NSString *md5;
    NSData *filebody;
...
@property(retain) NSData *filebody; // @synthesize filebody;
...
- (_Bool)hasMd5;
- (void)setHasFilebody:(_Bool)arg1;
- (_Bool)hasFilebody;
