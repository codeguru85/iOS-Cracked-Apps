...
@class ImageAnnotation, NSMutableArray, UIImage, UIImageView, UIPanGestureRecognizer, UIPinchGestureRecognizer, UISegmentedControl, UITapGestureRecognizer;

@interface ImageAnnotationViewController : UIViewController
{
    UIImage *_image;
    id <ImageAnnotationDelegate> _delegate;
...
@property(retain, nonatomic) ImageAnnotation *currentAnnotation; // @synthesize currentAnnotation=_currentAnnotation;
...
@property(nonatomic) __weak id <ImageAnnotationDelegate> delegate; // @synthesize delegate=_delegate;
