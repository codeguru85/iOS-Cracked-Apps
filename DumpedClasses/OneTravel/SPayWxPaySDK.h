...
@class NSString, SPayWxPayConfiguration;

@interface SPayWxPaySDK : SPaySDK <ONEAppDelegateStoreDelegate>
{
...
@property(retain, nonatomic) SPayWxPayConfiguration *configuration;
