...
#import "DDIMMultipartFormData.h"

@class DDIMMultipartBodyStream, NSMutableURLRequest, NSString;

@interface DDIMStreamingMultipartFormData : NSObject <DDIMMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    DDIMMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) DDIMMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
