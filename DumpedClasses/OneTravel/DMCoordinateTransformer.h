...
@interface DMCoordinateTransformer : NSObject
{
}

+ (struct _DiDiRouteMapPoint)SCTXMapPointFromServerPoint:(struct _DiDiRouteMapPoint)arg1;
+ (struct _DiDiRouteMapPoint)SCTXMapPointForCoordinate:(struct CLLocationCoordinate2D)arg1;
+ (struct CLLocationCoordinate2D)CoordFromServerPoint:(struct _DiDiRouteMapPoint)arg1;
+ (struct _DiDiRouteMapPoint)ServerPointFromCoord:(struct CLLocationCoordinate2D)arg1;
