...
@class NSArray, NSMutableArray, NSString, PBServiceOptions;
...
@property(retain) NSMutableArray *methodArray; // @synthesize methodArray;
...
@property(readonly) NSArray *method; // @dynamic method;
- (id)defaultInstance;
- (id)init;
