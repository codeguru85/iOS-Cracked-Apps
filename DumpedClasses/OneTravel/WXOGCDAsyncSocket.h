...
@class NSData, NSMutableArray, NSString, NSURL, WXOGCDAsyncReadPacket, WXOGCDAsyncSocketPreBuffer, WXOGCDAsyncWritePacket;

@interface WXOGCDAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <WXOGCDAsyncSocketDelegate> delegate;
    ...
    WXOGCDAsyncReadPacket *currentRead;
    WXOGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    WXOGCDAsyncSocketPreBuffer *preBuffer;
    CDStruct_4210025a streamContext;
    struct __CFReadStream *readStream;
    struct __CFWriteStream *writeStream;
    struct SSLContext *sslContext;
    WXOGCDAsyncSocketPreBuffer *sslPreBuffer;
...
@property __weak id <WXOGCDAsyncSocketDelegate> delegate;
