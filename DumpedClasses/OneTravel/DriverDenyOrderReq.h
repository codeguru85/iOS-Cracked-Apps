...
@class DriverDenyOrderReq_LastStatus, NSString;

@interface DriverDenyOrderReq : GPBMessage
{
}
...
@property(retain, nonatomic) DriverDenyOrderReq_LastStatus *lastStatus; // @dynamic lastStatus;
