...
@class NSString, TDLocation;

@interface TDBaseStation : TDBaseModel
{
    int _systemId;
    int _networkId;
    int _bastationId;
    ...
    NSString *_mnc;
    NSString *_operator;
    TDLocation *_location;
}

@property(nonatomic) int asuLevel; // @synthesize asuLevel=_asuLevel;
@property(retain, nonatomic) TDLocation *location; // @synthesize location=_location;
