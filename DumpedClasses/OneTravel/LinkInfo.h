...
@class DiffGeoPoints, GPBInt32Array, GPBInt64Array, GPBUInt32Array, NSMutableArray, NSString;

@interface LinkInfo : GPBMessage
{
}
...
@property(retain, nonatomic) DiffGeoPoints *points; // @dynamic points;
