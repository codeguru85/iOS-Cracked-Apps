...
@class NSString, SPayAlipayConfiguration;

@interface SPayAlipaySDK : SPaySDK <ONEAppDelegateStoreDelegate>
{
...
@property(retain, nonatomic) SPayAlipayConfiguration *configuration;
