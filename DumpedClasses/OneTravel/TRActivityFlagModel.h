...
@class NSNumber<Optional>, NSString<Optional>, TRFastCarFlagModel<Optional>;

@interface TRActivityFlagModel : JSONModel
{
    ...
    TRFastCarFlagModel<Optional> *_fast_car;
}

@property(retain, nonatomic) TRFastCarFlagModel<Optional> *fast_car; // @synthesize fast_car=_fast_car;
