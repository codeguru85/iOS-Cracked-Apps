...
- (void)drc_addHighTextArray:(id)arg1 highlightStyle:(id)arg2;
- (void)drc_setText:(id)arg1 highlightTextArray:(id)arg2 highlightStyle:(id)arg3;
- (void)drc_setText:(id)arg1 highlightText:(id)arg2 highlightStyle:(id)arg3;
- (void)drc_setText:(id)arg1 hightLightIdentifier:(id)arg2 highlightStyle:(id)arg3;
- (id)placeHolderString:(long long)arg1;
- (void)setClickPhoneNumberStyle:(id)arg1 pressed:(id)arg2;
