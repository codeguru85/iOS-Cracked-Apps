...
@class NSString, TMapBeaconRequestPackage;

@interface TMapBeaconReqDataPackage : NSObject
{
    TMapBeaconRequestPackage *requestPackage;
    NSString *reqKey;
    NSString *reqServant;
    NSString *reqFunc;
    int zipAlg;
...
@property(retain, nonatomic) TMapBeaconRequestPackage *requestPackage; // @synthesize requestPackage;
- (void).cxx_destruct;
- (void)dealloc;
