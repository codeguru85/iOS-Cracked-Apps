...
@class DDIMHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface DDIMMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    DDIMHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) DDIMHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
