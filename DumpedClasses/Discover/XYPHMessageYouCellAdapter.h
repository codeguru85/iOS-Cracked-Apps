...
@interface XYPHMessageYouCellAdapter : NSObject
{
...
- (void)setNoteAtCell:(id)arg1 withModel:(id)arg2;
- (void)setNoteCommentCell:(id)arg1 withModel:(id)arg2;
- (void)setNoteCell:(id)arg1 withModel:(id)arg2;
- (void)setFriendCell:(id)arg1 withModel:(id)arg2;
- (void)setFanCell:(id)arg1 withModel:(id)arg2;
- (void)setHeaderCell:(id)arg1 withType:(unsigned long long)arg2 model:(id)arg3;
