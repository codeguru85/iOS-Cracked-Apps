...
@interface XYPHStoreVendorStickyHeaderView : UIView
{
    id <XYPHStoreVendorStickyHeaderViewDelegate> _delegate;
...
@property(nonatomic) __weak id <XYPHStoreVendorStickyHeaderViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
