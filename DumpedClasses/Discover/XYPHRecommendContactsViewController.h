...
@interface XYPHRecommendContactsViewController : XYPHBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, MFMessageComposeViewControllerDelegate, XYPHRecommendThirdPartyUserDetailCellDelegate, UISearchBarDelegate>
{
    _Bool _isLoadingContactsList;
    _Bool _searchMode;
    NSMutableDictionary *_statusDic;
    UICollectionView *_phoneContactsTableView;
    NSMutableArray *_contactsArray;
    long long _page;
    XYPHRecommendThirdPartyUserDetailCellAdapter *_detailAdapter;
    XYPHRecommendThirdPartyCellAdapter *_contactsAdapter;
    NSString *_keyword;
}
...
@property(retain, nonatomic) XYPHRecommendThirdPartyCellAdapter *contactsAdapter; // @synthesize contactsAdapter=_contactsAdapter;
...
@property(nonatomic) _Bool isLoadingContactsList; // @synthesize isLoadingContactsList=_isLoadingContactsList;
@property(nonatomic) long long page; // @synthesize page=_page;
@property(retain, nonatomic) NSMutableArray *contactsArray; // @synthesize contactsArray=_contactsArray;
@property(retain, nonatomic) UICollectionView *phoneContactsTableView; // @synthesize phoneContactsTableView=_phoneContactsTableView;
@property(retain, nonatomic) NSMutableDictionary *statusDic; // @synthesize statusDic=_statusDic;
- (void).cxx_destruct;
- (void)sendInAppMessage:(id)arg1;
- (void)searchContactsList;
- (void)getContactsList;
- (void)loadPhoneContacts;
- (void)requestRecommendStatus:(CDUnknownBlockType)arg1;
- (void)uploadContactsFinish;
