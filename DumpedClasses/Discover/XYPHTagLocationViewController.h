...
@class NSDictionary, NSString, UICollectionView, XYEmptyPlaceholderView, XYPHRefreshBaseDataSource, XYPHTagsFilterTagHeaderView;

@interface XYPHTagLocationViewController : XYPHBaseCollectionRefreshViewController <UICollectionViewDelegate, UICollectionViewDataSource, CHTCollectionViewDelegateWaterfallLayout, XYPHTagsFilterTagHeaderViewDelegate>
{
    XYPHRefreshBaseDataSource *_dataSource;
    NSString *_tagId;
    NSString *_defaultSelectedTag;
...
@property(retain, nonatomic) NSString *defaultSelectedTag; // @synthesize defaultSelectedTag=_defaultSelectedTag;
