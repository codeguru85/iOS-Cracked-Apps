...
@class NSMutableDictionary, UIButton, UIImageView, UILabel, UIView, XYCTDisplayView;

@interface XYPHNoteGridStyleHomeCell : UICollectionViewCell
{
...
@property(retain, nonatomic) UILabel *descNoCoreLabel; // @synthesize descNoCoreLabel=_descNoCoreLabel;
