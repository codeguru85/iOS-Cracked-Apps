...
@interface XYPHStoreEventSaleSwitchHeaderView : UICollectionReusableView
{
    id <XYPHStoreEventSaleSwitchHeaderViewDelegate> _delegate;
...
@property(nonatomic) __weak id <XYPHStoreEventSaleSwitchHeaderViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)showCategory;
- (void)hideCategory;
