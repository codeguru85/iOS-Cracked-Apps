...
@class NSString, TuSDKFilterParameter, TuSDKGPUGrayscaleContrastFilter, TuSDKGPUSkinFilter;

@interface TuSDKGPUSkinWhiteningFilter : GPUImageFilterGroup <TuSDKFilterParameterProtocol>
{
    TuSDKGPUGrayscaleContrastFilter *_grayscaleContrastFilter;
    TuSDKGPUSkinFilter *_skinFilter;
