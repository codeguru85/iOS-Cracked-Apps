...
@class NSMutableArray, NSNumber, NSString, UICollectionView, UILabel, UIView, XYVGPlaceHolderView;

@interface XYPHEditFollowingTagsViewController : XYPHBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource>
{
    NSString *_userID;
    NSNumber *_gender;
    NSMutableArray *_tagList;
    UICollectionView *_contentView;
    XYVGPlaceHolderView *_tagPlaceHolderView;
...
@property(retain, nonatomic) XYVGPlaceHolderView *tagPlaceHolderView; // @synthesize tagPlaceHolderView=_tagPlaceHolderView;
