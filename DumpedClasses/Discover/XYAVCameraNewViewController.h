...
@interface XYAVCameraNewViewController : XYPHBaseViewController <UIGestureRecognizerDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
{
    UIView *previewView;
...
- (void)setupAVCapture;
- (double)XYAVRadiansToDegrees:(double)arg1;
- (double)XYAVDegreesToRadians:(double)arg1;
