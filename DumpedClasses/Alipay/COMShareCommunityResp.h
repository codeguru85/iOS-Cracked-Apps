...
@interface COMShareCommunityResp : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasMockString; // @dynamic hasMockString;
@property(readonly) _Bool hasResultStatus; // @dynamic hasResultStatus;
@property(retain, nonatomic) NSString *memo; // @dynamic memo;
@property(retain, nonatomic) NSString *mockString; // @dynamic mockString;
