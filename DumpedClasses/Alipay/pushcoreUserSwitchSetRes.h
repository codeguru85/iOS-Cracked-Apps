...
@interface pushcoreUserSwitchSetRes : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *errorTips; // @dynamic errorTips;
@property(readonly) _Bool hasErrorTips; // @dynamic hasErrorTips;
