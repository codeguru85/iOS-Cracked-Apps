...
@interface FetchIgnoreSceCodeListRespPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasIgnoreScencList; // @dynamic hasIgnoreScencList;
@property(readonly) _Bool hasMemo; // @dynamic hasMemo;
@property(readonly) _Bool hasResultStatus; // @dynamic hasResultStatus;
@property(retain, nonatomic) NSArray *ignoreScencList; // @dynamic ignoreScencList;
