...
@class NSDictionary, NSString, NSValue, PKCloudImageView, UIButton, UILabel, UITapGestureRecognizer, UIView;

@interface PKSnapChatVideoWidget : PKView
{
    _Bool _frameChange;
    NSDictionary *_chatDataSource;
    id <PKSnapChatVideoWidgetDelegate> _delegate;
    NSString *_videoUrl;
...
@property(nonatomic) __weak id <PKSnapChatVideoWidgetDelegate> delegate; // @synthesize delegate=_delegate;
