...
@interface TBSDKCacheStorage : NSObject
{
    ...
    struct dispatch_group_s *downloadGroup;
    _Bool _syncflag;
    NSString *_path;
...
@property(nonatomic) SEL getAllKeys; // @synthesize getAllKeys=_getAllKeys;
@property(nonatomic) SEL selSelect; // @synthesize selSelect=_selSelect;
@property(nonatomic) SEL selDestroy; // @synthesize selDestroy=_selDestroy;
@property(nonatomic) SEL selRemove; // @synthesize selRemove=_selRemove;
@property(nonatomic) SEL selInsert; // @synthesize selInsert=_selInsert;
@property(nonatomic) SEL selReMaxSize; // @synthesize selReMaxSize=_selReMaxSize;
@property(nonatomic) SEL selInstance; // @synthesize selInstance=_selInstance;
