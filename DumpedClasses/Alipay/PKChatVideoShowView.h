...
@class NSDictionary, NSString, NSValue, PKCloudImageView, UIButton, UIImageView, UILabel, UITapGestureRecognizer;

@interface PKChatVideoShowView : PKView
{
    _Bool _frameChange;
    ...
    PKCloudImageView *_videShowView;
...
@property(retain, nonatomic) PKCloudImageView *videShowView; // @synthesize videShowView=_videShowView;
