...
@interface MOBILECHATEmotionPackageBriefResp : APDPBGeneratedMessage <NSCoding>
{
}
...
@property(retain, nonatomic) NSArray *emotionPackageBriefVOs; // @dynamic emotionPackageBriefVOs;
