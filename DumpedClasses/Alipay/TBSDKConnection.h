...
@class NSData, NSDictionary, NSError, NSHTTPURLResponse, NSMutableArray, NSMutableData, NSMutableDictionary, NSMutableURLRequest, NSString, NSURL, NSURLConnection, NWHTTPRequestOperation;
...
@interface TBSDKConnection : NSObject <NSURLConnectionDelegate>
{
    ...
    long long _fileSize;
    NWHTTPRequestOperation *_nop;
}

+ (void)cancelAll;
+ (id)requestWithURL:(id)arg1;
+ (void)initialize;
@property(retain, nonatomic) NWHTTPRequestOperation *nop; // @synthesize nop=_nop;
