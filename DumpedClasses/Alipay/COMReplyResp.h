...
@class COMReply, NSString;

@interface COMReplyResp : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasReply; // @dynamic hasReply;
...
@property(retain, nonatomic) COMReply *reply; // @dynamic reply;
