...
@interface BLSearchBar : UIView <UITextFieldDelegate>
{
    _Bool _isSupportHanziMode;
    _Bool _shouldShowVoiceButton;
    NSString *_text;
    unsigned long long _style;
    id <BLSearchBarDelegate> _delegate;
...
@property(nonatomic) __weak id <BLSearchBarDelegate> delegate; // @synthesize delegate=_delegate;
