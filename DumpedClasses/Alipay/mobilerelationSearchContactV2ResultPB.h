...
@interface mobilerelationSearchContactV2ResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *resultType; // @dynamic resultType;
@property(retain, nonatomic) NSArray *searchResultVOList; // @dynamic searchResultVOList;
