...
@interface mobilerelationAddressUploadResult : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasSnsUploadAddress; // @dynamic hasSnsUploadAddress;
...
@property(retain, nonatomic) NSString *snsUploadAddress; // @dynamic snsUploadAddress;
