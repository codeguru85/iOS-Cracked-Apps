...
@class NSDictionary, NSString, PECard;

@interface PEFundChannelData : NSObject
{
    _Bool _needBindNewCard;
    PECard *_currentpayCard;
    NSString *_bizLimit;
...
@property(retain, nonatomic) PECard *currentpayCard; // @synthesize currentpayCard=_currentpayCard;
- (void).cxx_destruct;
