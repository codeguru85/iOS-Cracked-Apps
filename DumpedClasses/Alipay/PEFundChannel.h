...
@class NSString, PEBankCardChannel;

@interface PEFundChannel : NSObject <NSCoding>
{
    ...
    PEBankCardChannel *_bankCardChannel;
}

@property(retain, nonatomic) PEBankCardChannel *bankCardChannel; // @synthesize bankCardChannel=_bankCardChannel;
