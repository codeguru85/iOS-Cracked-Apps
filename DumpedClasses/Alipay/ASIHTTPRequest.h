...
+ (void)initialize;
@property unsigned int dataId; // @synthesize dataId;
...
@property(retain) id <ASICacheDelegate> downloadCache; // @synthesize downloadCache;
...
@property(retain) ASIHTTPRequest *mainRequest; // @synthesize mainRequest;
...
@property(retain, nonatomic) id downloadProgressDelegate; // @synthesize downloadProgressDelegate;
@property(retain, nonatomic) id uploadProgressDelegate; // @synthesize uploadProgressDelegate;
