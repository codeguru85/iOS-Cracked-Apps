...
@class NSString, mobilerelationSimpleProfileRecord;

@interface mobilerelationSimpleProfileResult : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) mobilerelationSimpleProfileRecord *record; // @dynamic record;
