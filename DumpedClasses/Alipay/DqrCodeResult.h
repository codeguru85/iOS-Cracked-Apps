...
@interface DqrCodeResult : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *dqrcode; // @dynamic dqrcode;
@property(readonly) _Bool hasDqrcode; // @dynamic hasDqrcode;
