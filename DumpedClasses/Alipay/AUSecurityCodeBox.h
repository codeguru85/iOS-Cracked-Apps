...
@class AUTextField, UIButton, UILabel;
...
@interface AUSecurityCodeBox : UIView
{
    ...
    id <AUSecurityCodeBoxDelegate> _delegate;
}

+ (float)heightOfControl;
@property(nonatomic) __weak id <AUSecurityCodeBoxDelegate> delegate; // @synthesize delegate=_delegate;
