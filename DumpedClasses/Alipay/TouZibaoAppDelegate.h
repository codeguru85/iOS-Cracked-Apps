...
@class NSString, TZBHomeViewController;

@interface TouZibaoAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    TZBHomeViewController *_homeViewController;
}

@property(retain, nonatomic) TZBHomeViewController *homeViewController; // @synthesize homeViewController=_homeViewController;
- (void).cxx_destruct;
