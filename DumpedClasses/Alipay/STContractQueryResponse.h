...
@interface STContractQueryResponse : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *agreementNo; // @dynamic agreementNo;
@property(readonly) _Bool hasAgreementNo; // @dynamic hasAgreementNo;
