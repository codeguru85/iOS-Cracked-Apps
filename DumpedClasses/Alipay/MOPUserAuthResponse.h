...
@interface MOPUserAuthResponse : NSObject
{
    _Bool _success;
    _Bool _aweAuthed;
    _Bool _zhimaAuthed;
...
@property(nonatomic) _Bool zhimaAuthed; // @synthesize zhimaAuthed=_zhimaAuthed;
@property(nonatomic) _Bool aweAuthed; // @synthesize aweAuthed=_aweAuthed;
