...
@property(retain, nonatomic, setter=setDownloadProgressDelegate:) id downloadProgressDelegate; // @synthesize downloadProgressDelegate;
@property(retain, nonatomic, setter=setUploadProgressDelegate:) id uploadProgressDelegate; // @synthesize uploadProgressDelegate;
