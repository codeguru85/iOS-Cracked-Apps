...
@interface LifeQueryPhotesResult : APPBGeneratedMessage <NSCoding, GeneratedMessageProtocol>
{
    _Bool _hasSuccess;
...
@property(retain, nonatomic) NSMutableArray *photoItem; // @synthesize photoItem=_photoItem;
...
- (void)setPhotoItemArray:(id)arg1;
- (int)serializedSize;
