...
@class NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSObject<OS_dispatch_data>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest, SRDelegateController, SRIOConsumerPool, SRProxyConnect, SRSecurityPolicy;
