...
@class HAllAppViewController, NSString;

@interface AllAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    HAllAppViewController *_rootController;
}

@property(retain, nonatomic) HAllAppViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
