...
@class AliTallyLauncherManager, NSString, UIViewController;

@interface AssetTallyAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    UIViewController *_rootController;
    AliTallyLauncherManager *_launcherManager;
}

@property(retain, nonatomic) AliTallyLauncherManager *launcherManager; // @synthesize launcherManager=_launcherManager;
@property(retain, nonatomic) UIViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
- (void)gotoCreateNodeViewControlerInApplication:(id)arg1;
- (void)parseTallyAppOptions:(id)arg1 application:(id)arg2;
