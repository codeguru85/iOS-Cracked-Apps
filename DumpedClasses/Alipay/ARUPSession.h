...
#import "ARUPConnectionGroupDelegate.h"
#import "ARUPFrameDecoderDelegate.h"

@class ARUPFrameDecoder, NSMutableData, NSString;

@interface ARUPSession : NSObject <ARUPConnectionGroupDelegate, ARUPFrameDecoderDelegate>
{
