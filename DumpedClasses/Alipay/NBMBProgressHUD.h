...
@interface NBMBProgressHUD : UIView
{
    _Bool useAnimation;
    ...
    int mode;
    float progress;
    id <NBMBProgressHUDDelegate> delegate;
    UIFont *labelFont;
...
+ (id)showHUDAddedTo:(id)arg1 target:(id)arg2 action:(SEL)arg3;
...
@property __weak id <NBMBProgressHUDDelegate> delegate; // @synthesize delegate;
