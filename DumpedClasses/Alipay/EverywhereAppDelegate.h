...
@interface EverywhereAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    UITabBarController *_rootController;
}

+ (id)appId;
@property(retain, nonatomic) UITabBarController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
