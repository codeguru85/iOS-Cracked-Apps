...
@interface MOPComplainRequest : NSObject
{
    NSString *_system;
    NSString *_city;
    ...
    NSString *_reason;
    NSString *_desc;
    NSArray *_evidenceImg;
}

+ (Class)evidenceImgElementClass;
@property(retain, nonatomic) NSArray *evidenceImg; // @synthesize evidenceImg=_evidenceImg;
