...
@class INPhotoEditLauncher, NSString, UIViewController;

@interface BeeImageEditorAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    UIViewController *_rootController;
    INPhotoEditLauncher *_editLauncher;
}

@property(retain, nonatomic) INPhotoEditLauncher *editLauncher; // @synthesize editLauncher=_editLauncher;
