...
@class MtopExtRequest, NSArray, NSDictionary, NSMutableDictionary, NSString, NSThread, NSURL, TBSDKAsync4jInterceptor;
...
- (void)fillInResponseString:(id)arg1;
- (void)startConnection;
- (void)setMtopMethod:(id)arg1;
- (id)mtopMethod;
