...
@interface PresentPassResult : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasPresentOutId; // @dynamic hasPresentOutId;
@property(readonly) _Bool hasPresentStatus; // @dynamic hasPresentStatus;
...
@property(retain, nonatomic) NSString *presentOutId; // @dynamic presentOutId;
@property(retain, nonatomic) NSString *presentStatus; // @dynamic presentStatus;
