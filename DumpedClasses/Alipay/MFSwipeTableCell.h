...
@class CADisplayLink, MFSwipeButtonsView, MGSwipeAnimationData, MGSwipeExpansionSettings, MGSwipeSettings, MGSwipeTableInputOverlay, NSArray, NSMutableSet, UIColor, UIImageView, UIPanGestureRecognizer, UITableView, UITapGestureRecognizer, UIView;
