...
- (void)PSDURLProtocolProcessor:(id)arg1 didFinishLoading:(id)arg2 receiveDataLength:(unsigned long long)arg3;
...
- (void)reportProfile;
- (void)startStatistics:(id)arg1 receiveDataLength:(unsigned long long)arg2 error:(id)arg3;
- (id)init;
