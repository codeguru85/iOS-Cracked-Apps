...
@interface SCDictCache : SCCacheBase
{
    NSMutableDictionary *_internalCache;
}

+ (id)dictCacheWithType:(long long)arg1;
+ (id)dictCache;
@property(retain, nonatomic) NSMutableDictionary *internalCache; // @synthesize internalCache=_internalCache;
- (void).cxx_destruct;
