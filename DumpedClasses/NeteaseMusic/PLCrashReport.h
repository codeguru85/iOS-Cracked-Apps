...
+ (id)SHA1HashBytesWithPlainBytes:(id)arg1;
+ (id)SHA1HashStringWithPlainBytes:(id)arg1;
+ (id)SHA1HashBytesWithPlainText:(id)arg1;
+ (id)SHA1HashStringWithPlainText:(id)arg1;
...
- (id)exportCrashReportString;
- (id)fingerPrintWithOption:(int)arg1;
- (id)fingerPrint;
