...
{
    unsigned long long _executionOrder;
...
@property(nonatomic) unsigned long long executionOrder; // @synthesize executionOrder=_executionOrder;
- (void).cxx_destruct;
...
- (id)downloadImageWithURL:(id)arg1 timeOutInterval:(double)arg2 options:(unsigned long long)arg3 progress:(CDUnknownBlockType)arg4 completed:(CDUnknownBlockType)arg5;
