...
#import "MMAFMultipartFormData.h"

@class MMAFMultipartBodyStream, NSMutableURLRequest, NSString;

@interface MMAFStreamingMultipartFormData : NSObject <MMAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    MMAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) MMAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
