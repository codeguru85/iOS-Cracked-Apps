...
@interface ASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    NSString *proxyType;
    NSURL *PACurl;
    unsigned long long authenticationNeeded;
    ...
    unsigned long long cacheStoragePolicy;
...
+ (id)requestWithURL:(id)arg1 usingCache:(id)arg2 andCachePolicy:(unsigned long long)arg3;
...
@property unsigned long long cacheStoragePolicy; // @synthesize cacheStoragePolicy;
...
@property unsigned long long authenticationNeeded; // @synthesize authenticationNeeded;
...
@property SEL evaluateTrustSelector; // @synthesize evaluateTrustSelector;
...
- (void)evaluateTrustIfNeeded:(unsigned long long)arg1;
- (_Bool)evaluateServerTrustIfNeeded:(unsigned long long)arg1 readStream:(id)arg2;
