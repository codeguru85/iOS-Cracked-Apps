...
- (void)clearCachedResponsesForStoragePolicy:(unsigned long long)arg1;
@property(nonatomic) unsigned long long defaultCachePolicy; // @synthesize defaultCachePolicy;
