...
- (id)initWithAnimtedImage:(id)arg1;
- (void)createPosterImage:(id)arg1 index:(unsigned long long)arg2;
- (void)commonInitAfterParseImage:(unsigned long long)arg1;
- (void)commonInitDataStructures;
- (id)init;
