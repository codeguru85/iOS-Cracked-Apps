...
@class NSAttributedString, NSDataDetector, NSMutableArray, NSString, NSTextCheckingResult, UIColor;
...
@interface OHAttributedLabel : UILabel <UIAppearance>
{
    ...
    unsigned int _linkUnderlineStyle;
...
@property(nonatomic) unsigned int linkUnderlineStyle; // @synthesize linkUnderlineStyle=_linkUnderlineStyle;
