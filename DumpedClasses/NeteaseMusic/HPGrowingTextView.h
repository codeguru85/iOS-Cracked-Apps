...
@class CALayer, HPTextViewInternal, NSObject<HPGrowingTextViewDelegate>, NSString, UIColor, UIFont, UITextView;
...
@interface HPGrowingTextView : UIView <UITextViewDelegate>
{
    ...
    UIFont *font;
    UIColor *textColor;
    double _topHideHeight;
    double _bottomHideHeight;
}

@property(nonatomic) double bottomHideHeight; // @synthesize bottomHideHeight=_bottomHideHeight;
@property(nonatomic) double topHideHeight; // @synthesize topHideHeight=_topHideHeight;
