...
- (id)renderResult:(id)arg1 width:(int)arg2 height:(int)arg3;
- (id)encode:(id)arg1 format:(int)arg2 width:(int)arg3 height:(int)arg4 encoding:(unsigned long long)arg5 eccPercent:(int)arg6 layers:(int)arg7;
