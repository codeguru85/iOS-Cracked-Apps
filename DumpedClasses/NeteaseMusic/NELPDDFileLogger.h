...
#import "NELPDDAbstractLogger.h"

#import "NELPDDLogger.h"

@class NELPDDLogFileInfo, NSFileHandle, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString;

@interface NELPDDFileLogger : NELPDDAbstractLogger <NELPDDLogger>
{
    id <NELPDDLogFileManager> _logFileManager;
    NELPDDLogFileInfo *_currentLogFileInfo;
    ...
    id <NELPDDLogFileManager> logFileManager;
}
...
@property(readonly, nonatomic) id <NELPDDLogFileManager> logFileManager; // @synthesize logFileManager;
- (void).cxx_destruct;
...
@property(retain, nonatomic) id <NELPDDLogFormatter> logFormatter;
