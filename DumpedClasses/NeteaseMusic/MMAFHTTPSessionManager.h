...
#import "MMAFURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class MMAFHTTPRequestSerializer<MMAFURLRequestSerialization>, MMAFHTTPResponseSerializer<MMAFURLResponseSerialization>, MMAFSecurityPolicy, NSURL;

@interface MMAFHTTPSessionManager : MMAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    MMAFHTTPRequestSerializer<MMAFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) MMAFHTTPRequestSerializer<MMAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) MMAFSecurityPolicy *securityPolicy; // @dynamic securityPolicy;
@property(retain, nonatomic) MMAFHTTPResponseSerializer<MMAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
