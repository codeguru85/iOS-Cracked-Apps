...
@interface NMYiXinManager : NMXinSDKManager
{
}

- (_Bool)sendImage:(id)arg1 scene:(unsigned long long)arg2;
- (_Bool)sendTextMessage:(id)arg1 scene:(unsigned long long)arg2;
- (_Bool)sendMediaMessageWithTitle:(id)arg1 description:(id)arg2 image:(id)arg3 url:(id)arg4 musicURL:(id)arg5 musicDataURL:(id)arg6 videoURL:(id)arg7 scene:(unsigned long long)arg8 prefilledText:(id)arg9 object:(id)arg10;
