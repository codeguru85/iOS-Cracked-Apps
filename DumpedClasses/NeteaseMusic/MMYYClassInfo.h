...
@interface MMYYClassInfo : NSObject
{
    _Bool _needUpdate;
    _Bool _isMeta;
    Class _cls;
...
@property(readonly, nonatomic) MMYYClassInfo *superClassInfo; // @synthesize superClassInfo=_superClassInfo;
