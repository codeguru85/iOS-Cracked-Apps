...
@interface MTLabel : UIView
{
    ...
    NSArray *_changeColors;
    NSArray *_changeColorRanges;
}

+ (id)labelWithText:(id)arg1;
+ (id)labelWithFrame:(struct CGRect)arg1 andText:(id)arg2;
+ (id)label;
@property(retain, nonatomic) NSArray *changeColorRanges; // @synthesize changeColorRanges=_changeColorRanges;
@property(retain, nonatomic) NSArray *changeColors; // @synthesize changeColors=_changeColors;
...
- (id)init;
- (void)setup;
@property(nonatomic, getter=textAlignment, setter=setTextAlignment:) unsigned long long _textAlignment; // @synthesize _textAlignment;
