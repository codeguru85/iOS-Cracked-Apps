...
- (void)dealloc;
- (void)finalize;
- (unsigned long long)countQueryFromResutSet;
- (id)allResultEntry;
- (id)albumTrackIdArrayFromResultSet;
- (id)userAlbumArrayFromResultSet;
- (id)userAlbumIdArrayFromResultSet;
- (id)albumArrayFromResultSetCheckAlbumId:(_Bool)arg1;
- (id)playingListArrayFromResultSet_v2;
- (id)recentPlayCollectionArrayFromResultSet_v2;
- (id)localPrivateMsgArrayFromResultSet_v2;
- (id)localEventArrayFromResultSet_v2;
- (id)mvArrayFromResultSet_v2;
- (id)ipodSongArrayFromResultSet;
- (id)downloadProgramArrayFromResultSet;
- (id)lastPlayProgramArrayFromResultSet;
- (id)recentPlayArrayFromResultSet_v2;
- (id)playlistArrayFromResultSet_v2;
- (id)downloadTrackArrayFromResultSet_v2;
- (id)songArrayFromResultSet_v2;
- (id)songArrayFromResultSet;
