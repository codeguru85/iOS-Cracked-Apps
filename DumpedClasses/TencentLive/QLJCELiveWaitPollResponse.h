...
@class NSDictionary, NSString, QLJCEAction, QLJCELiveLightInfo;

@interface QLJCELiveWaitPollResponse : JceObjectV2
{
    ...
    int jcev2_p_17_o_vipJump;
    int jcev2_p_18_o_liveSubStatus;
    ...
    long long jcev2_p_16_o_waitRank;
...
@property(nonatomic, getter=jce_liveSubStatus, setter=setJce_liveSubStatus:) int jcev2_p_18_o_liveSubStatus; // @synthesize jcev2_p_18_o_liveSubStatus;
@property(nonatomic, getter=jce_vipJump, setter=setJce_vipJump:) int jcev2_p_17_o_vipJump; // @synthesize jcev2_p_17_o_vipJump;
@property(nonatomic, getter=jce_waitRank, setter=setJce_waitRank:) long long jcev2_p_16_o_waitRank; // @synthesize jcev2_p_16_o_waitRank;
