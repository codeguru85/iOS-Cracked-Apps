...
@class NSString, QLASIHTTPRequest, QLJCEVipH5GameConfigResponse;

@interface QLCommonActivityDataModel : QLRequestModel
{
    QLJCEVipH5GameConfigResponse *_gameConfigResponse;
...
@property(retain, nonatomic) QLJCEVipH5GameConfigResponse *gameConfigResponse; // @synthesize gameConfigResponse=_gameConfigResponse;
- (void).cxx_destruct;
