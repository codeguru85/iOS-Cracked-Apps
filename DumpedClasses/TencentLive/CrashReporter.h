...
- (void)setSigkillReportCallback:(CDUnknownFunctionPointerType)arg1;
...
- (void)enableConsoleLogReport:(_Bool)arg1;
- (void)enableViewControllerTracking:(_Bool)arg1;
...
- (_Bool)install;
- (void)setUserCrashHandlerCallback:(CDUnknownFunctionPointerType)arg1;
