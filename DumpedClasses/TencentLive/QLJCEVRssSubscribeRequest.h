...
@interface QLJCEVRssSubscribeRequest : JceObjectV2
{
    BOOL jcev2_p_0_r_option;
...
@property(nonatomic, getter=jce_option, setter=setJce_option:) BOOL jcev2_p_0_r_option; // @synthesize jcev2_p_0_r_option;
- (void).cxx_destruct;
- (id)init;
