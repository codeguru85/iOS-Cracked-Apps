...
@class LGSRIOConsumerPool, NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSObject<OS_dispatch_queue>, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest;
...
@interface LGSRWebSocket : NSObject <NSStreamDelegate>
{
    ...
    LGSRWebSocket *_selfRetain;
    NSArray *_requestedProtocols;
    LGSRIOConsumerPool *_consumerPool;
    int _readyState;
    id <LGSRWebSocketDelegate> _delegate;
    NSURL *_url;
    NSString *_protocol;
    NSArray *_sslData;
}
...
+ (void)initialize;
@property(retain, nonatomic) NSArray *sslData; // @synthesize sslData=_sslData;
...
@property(nonatomic) __weak id <LGSRWebSocketDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
