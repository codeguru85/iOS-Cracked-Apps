...
@class NSString, QLASIHTTPRequest, QLLiveInteractItem;

@interface QLLiveInteractModel : QLRequestModel
{
    NSString *_pid;
    QLLiveInteractItem *_liveInteractItem;
    QLASIHTTPRequest *_dataRequest;
}

@property(retain) QLASIHTTPRequest *dataRequest; // @synthesize dataRequest=_dataRequest;
@property(retain, nonatomic) QLLiveInteractItem *liveInteractItem; // @synthesize liveInteractItem=_liveInteractItem;
