...
@class APMidasAFMultipartBodyStream, NSMutableURLRequest, NSString;

@interface APMidasAFStreamingMultipartFormData : NSObject <AFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    APMidasAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) APMidasAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
