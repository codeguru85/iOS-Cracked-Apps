...
@interface QLJCEMyContributionsResponse : JceObjectV2
{
    _Bool jcev2_p_3_o_isHaveNextPage;
    int jcev2_p_0_r_errCode;
    NSArray *jcev2_p_1_r_itemList__b0x9i_VOQLJCEContributionsItem;
...
@property(retain, nonatomic, getter=jce_itemList, setter=setJce_itemList:) NSArray *jcev2_p_1_r_itemList__b0x9i_VOQLJCEContributionsItem; // @synthesize jcev2_p_1_r_itemList__b0x9i_VOQLJCEContributionsItem;
