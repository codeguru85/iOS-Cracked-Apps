...
@interface QLJCEFanTuanLatestRequest : JceObjectV2
{
    NSString *jcev2_p_0_o_type;
    NSString *jcev2_p_1_o_dataKey;
    NSString *jcev2_p_2_o_pageContext;
    NSString *jcev2_p_3_o_versionCode;
}

+ (id)jceType;
+ (void)initialize;
@property(retain, nonatomic, getter=jce_versionCode, setter=setJce_versionCode:) NSString *jcev2_p_3_o_versionCode; // @synthesize jcev2_p_3_o_versionCode;
