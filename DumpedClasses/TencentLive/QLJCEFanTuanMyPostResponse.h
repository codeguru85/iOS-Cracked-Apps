...
@interface QLJCEFanTuanMyPostResponse : JceObjectV2
{
    _Bool jcev2_p_3_o_hasNextPage;
    int jcev2_p_0_r_errCode;
    NSArray *jcev2_p_1_o_fanTuanFeedList__b0x9i_VOQLJCEONAFanTuanFeed;
...
@property(retain, nonatomic, getter=jce_fanTuanFeedList, setter=setJce_fanTuanFeedList:) NSArray *jcev2_p_1_o_fanTuanFeedList__b0x9i_VOQLJCEONAFanTuanFeed; // @synthesize jcev2_p_1_o_fanTuanFeedList__b0x9i_VOQLJCEONAFanTuanFeed;
