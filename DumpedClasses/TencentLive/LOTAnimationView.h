...
@property(retain, nonatomic) NSString *netZipUrl; // @synthesize netZipUrl=_netZipUrl;
@property(readonly, nonatomic) __weak id lotViewComID; // @synthesize lotViewComID=_lotViewComID;
- (void).cxx_destruct;
- (void)_layout;
...
@property(nonatomic) double animationRepeatCount;
