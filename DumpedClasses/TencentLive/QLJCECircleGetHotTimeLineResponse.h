...
@interface QLJCECircleGetHotTimeLineResponse : JceObjectV2
{
    ...
    NSString *jcev2_p_5_o_refreshContext;
}

+ (id)jceType;
+ (void)initialize;
@property(retain, nonatomic, getter=jce_refreshContext, setter=setJce_refreshContext:) NSString *jcev2_p_5_o_refreshContext; // @synthesize jcev2_p_5_o_refreshContext;
