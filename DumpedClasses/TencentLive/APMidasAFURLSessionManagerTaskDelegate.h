...
@class APMidasAFURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface APMidasAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    APMidasAFURLSessionManager *_manager;
...
@property(nonatomic) __weak APMidasAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
