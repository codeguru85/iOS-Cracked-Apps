...
@class APMidasAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface APMidasAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    APMidasAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) APMidasAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
