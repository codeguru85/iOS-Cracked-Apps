...
@interface QLJCEDetailVideoEndRecommendResponse : JceObjectV2
{
    _Bool jcev2_p_3_o_hasNextPage;
    int jcev2_p_0_r_errCode;
    int jcev2_p_4_o_uiType;
    int jcev2_p_5_o_videoType;
    int jcev2_p_6_o_hasPresent;
...
+ (id)jceType;
+ (void)initialize;
@property(nonatomic, getter=jce_hasPresent, setter=setJce_hasPresent:) int jcev2_p_6_o_hasPresent; // @synthesize jcev2_p_6_o_hasPresent;
@property(nonatomic, getter=jce_videoType, setter=setJce_videoType:) int jcev2_p_5_o_videoType; // @synthesize jcev2_p_5_o_videoType;
