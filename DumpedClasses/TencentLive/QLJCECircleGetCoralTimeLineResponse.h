...
@class NSArray, NSString, QLJCEActorInfo, QLJCECoralSummaryInfo;

@interface QLJCECircleGetCoralTimeLineResponse : JceObjectV2
{
    ...
    QLJCECoralSummaryInfo *jcev2_p_5_o_coralSummaryInfo;
}

+ (id)jceType;
+ (void)initialize;
@property(retain, nonatomic, getter=jce_coralSummaryInfo, setter=setJce_coralSummaryInfo:) QLJCECoralSummaryInfo *jcev2_p_5_o_coralSummaryInfo; // @synthesize jcev2_p_5_o_coralSummaryInfo;
