...
@interface NVMEAPWeexAppMonitorHandler : NSObject <WXAppMonitorProtocol>
{
}

+ (void)fallbackToWebFromWeexController:(id)arg1;
- (void)fallbackIfNeededOnFatalErrorTagName:(id)arg1;
