...
@class NSMutableArray, NSString, NVMEmptyHintView, NVMMessageMeta, NVMTableView;

@interface NVMMessageCenterViewController : NVMViewController <UITableViewDataSource, UITableViewDelegate>
{
