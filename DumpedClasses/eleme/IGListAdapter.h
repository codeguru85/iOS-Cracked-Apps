...
@interface IGListAdapter : NSObject <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, IGListCollectionContext, IGListDataContext, IGListBatchContext>
{
    UICollectionView *_collectionView;
    _Bool _isDequeuingCell;
    _Bool _isSendingWorkingRangeDisplayUpdates;
    NSMapTable *_viewSectionControllerMap;
    _Bool _showEmptyUsingBackgroundView;
...
@property(nonatomic) _Bool showEmptyUsingBackgroundView; // @synthesize showEmptyUsingBackgroundView=_showEmptyUsingBackgroundView;
- (void).cxx_destruct;
