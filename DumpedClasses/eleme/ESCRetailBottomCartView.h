...
@class ESCRetailCartViewController, ESCRetailCommonCartView, NSString, NVMCartResult, UILabel, UIViewController;

@interface ESCRetailBottomCartView : UIView <NVMCartDataSubscriber>
{
    long long _comeFrom;
    ESCRetailCommonCartView *_commonCartView;
    UIViewController *_parentViewController;
    id <NVMCartContextDataSource> _restaurantInfo;
    UILabel *_cartViewNotAvailableHintLabel;
    ESCRetailCartViewController *_cartViewController;
    NVMCartResult *_lastCartData;
}

@property(retain, nonatomic) NVMCartResult *lastCartData; // @synthesize lastCartData=_lastCartData;
@property(retain, nonatomic) ESCRetailCartViewController *cartViewController; // @synthesize cartViewController=_cartViewController;
...
@property(retain, nonatomic) ESCRetailCommonCartView *commonCartView; // @synthesize commonCartView=_commonCartView;
...
@property(readonly, nonatomic) UIView *cartImageView;
- (id)restaurantID;
