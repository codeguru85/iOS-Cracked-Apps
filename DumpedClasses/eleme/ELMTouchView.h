...
@interface ELMTouchView : UIView
{
    _Bool _touchEnabled;
    id <ELMTouchViewDelegate> _touchDelegate;
...
@property(nonatomic) __weak id <ELMTouchViewDelegate> touchDelegate; // @synthesize touchDelegate=_touchDelegate;
- (void).cxx_destruct;
