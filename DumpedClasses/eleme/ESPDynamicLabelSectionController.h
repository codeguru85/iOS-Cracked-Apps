...
@class ESPDynamicLabelViewModel, NSString;

@interface ESPDynamicLabelSectionController : IGListSectionController <IGListDisplayDelegate>
{
    CDUnknownBlockType _didSelectHotSearchAction;
    ESPDynamicLabelViewModel *_viewModel;
}

@property(retain, nonatomic) ESPDynamicLabelViewModel *viewModel; // @synthesize viewModel=_viewModel;
