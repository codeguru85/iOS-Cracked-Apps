...
@interface NVMWebViewProgress : NSObject <UIWebViewDelegate>
{
    ...
    _Bool _interactive;
    float _progress;
    id <NVMWebViewProgressDelegate> _progressDelegate;
...
@property(nonatomic) __weak id <NVMWebViewProgressDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
- (void).cxx_destruct;
