...
@class NSArray, NVMRoundRectView, UIColor, UIFont;

@interface NVMSegmentView : UIView
{
    long long _selectedSegmentIndex;
    CDUnknownBlockType _selectedIndexChangedAction;
    NSArray *_titles;
    NVMRoundRectView *_animatedLine;
    double _progress;
...
@property(retain, nonatomic) NVMRoundRectView *animatedLine; // @synthesize animatedLine=_animatedLine;
...
- (void)setAttributedTitle:(id)arg1 forIndex:(long long)arg2;
...
- (void)loadButtons;
- (void)configViewsWithTitle:(id)arg1 titleFont:(id)arg2 selectedFont:(id)arg3 selectedColor:(id)arg4 unSelectedColor:(id)arg5 lineColor:(id)arg6 backgroundColor:(id)arg7;
- (id)initWithTitles:(id)arg1 buttonTitleFont:(id)arg2 selectedFont:(id)arg3 selectedColor:(id)arg4 unSelectedColor:(id)arg5 lineColor:(id)arg6 backgroundColor:(id)arg7;
