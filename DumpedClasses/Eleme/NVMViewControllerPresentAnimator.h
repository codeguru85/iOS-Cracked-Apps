...
@interface NVMViewControllerPresentAnimator : NSObject <UIViewControllerAnimatedTransitioning>
{
...
- (id)initWithTransitionType:(unsigned long long)arg1 duration:(double)arg2;
