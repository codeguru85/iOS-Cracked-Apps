...
@interface FALocationActionSheet : FAAbstractActionSheet <UIPickerViewDelegate, UIPickerViewDataSource>
{
...
- (id)viewForContent;
- (void)showAtAreaId:(id)arg1 cityId:(id)arg2;
- (void)showAtIndexPath:(id)arg1;
- (id)init;
