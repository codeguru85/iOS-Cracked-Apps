...
@interface FAPopTipView : UIView
{
    ...
    id <FAPopTipViewDelegate> _delegate;
    NSString *_title;
    NSString *_message;
    UIView *_customView;
    id _targetObject;
...
@property(nonatomic) __weak id <FAPopTipViewDelegate> delegate; // @synthesize delegate=_delegate;
