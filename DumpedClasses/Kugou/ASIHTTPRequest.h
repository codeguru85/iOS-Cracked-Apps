...
@interface ASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    int tlsVersion;
    _Bool useLegacyTls;
    _Bool serverInlegacyTlsServers;
    _Bool _checkWifiOnly;
    _Bool _askUseWifiOnly;
    _Bool _kgIsConnected;
    double _startRequestTime;
    double _responesRequestTime;
    double _actTime;
}
...
+ (id)proxiesForURL:(id)arg1 fromPAC:(id)arg2;
...
+ (void)initialize;
+ (id)KGUserAgentCommon;
+ (id)defaultUserAgentString;
@property(nonatomic) double actTime; // @synthesize actTime=_actTime;
@property(nonatomic) double responesRequestTime; // @synthesize responesRequestTime=_responesRequestTime;
@property(nonatomic) double startRequestTime; // @synthesize startRequestTime=_startRequestTime;
@property(nonatomic) _Bool kgIsConnected; // @synthesize kgIsConnected=_kgIsConnected;
...
@property int tlsVersion; // @synthesize tlsVersion;
@property _Bool isNeedCheckIP; // @synthesize isNeedCheckIP=_isNeedCheckIP;
...
@property SEL didUnicomDataSelector; // @synthesize didUnicomDataSelector;
...
- (id)init;
- (void)handleFlowInc;
- (void)handleResponseHeader:(id)arg1;
- (void)setKGProxy;
- (void)SetKGUserAgent:(id)arg1;
@property(retain, nonatomic) NSString *operatorProxyName;
