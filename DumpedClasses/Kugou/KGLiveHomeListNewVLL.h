...
@interface KGLiveHomeListNewVLL : NSObject <UITableViewDataSource, UITableViewDelegate, KGLiveHomeListRefreshDelegate>
{
    UIView *_headerView;
...
- (void)configDataWithResult:(CDUnknownBlockType)arg1 refreshUI:(CDUnknownBlockType)arg2;
- (void)configListView;
- (id)init;
