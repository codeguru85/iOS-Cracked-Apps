...
@interface KTVMultiLineKrcView : UIView <UITableViewDataSource, UITableViewDelegate>
{
    ...
    UIImageView *bgView;
    id <KTVPanKrcViewDelegate> krcDelegate;
...
@property(nonatomic) _Bool lookUpModel; // @synthesize lookUpModel=_lookUpModel;
...
@property(nonatomic) __weak id <KTVPanKrcViewDelegate> krcDelegate; // @synthesize krcDelegate;
...
- (void).cxx_destruct;
- (void)dealloc;
- (void)setKrcNormalColor:(id)arg1 highLightColor:(id)arg2;
- (void)setOneRowLrcNoAnimatedLrc:(_Bool)arg1 highLightColorLrc:(id)arg2 colorLrc:(id)arg3;
- (void)setKrcScanFontHeight:(float)arg1;
- (void)canLookUpWithOutChangeProgress;
