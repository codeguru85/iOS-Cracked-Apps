...
@class KGThemeImageView, NSArray, NSMutableArray, UIColor, UIFont;

@interface FocusSwitch : UIControl
{
    ...
    KGThemeImageView *_sliderView;
    long long _selectedIndex;
    UIFont *_sliderFont;
}

+ (id)switchWithStringsArray:(id)arg1;
@property(retain, nonatomic) UIFont *sliderFont; // @synthesize sliderFont=_sliderFont;
@property(nonatomic) long long selectedIndex; // @synthesize selectedIndex=_selectedIndex;
@property(retain, nonatomic) KGThemeImageView *sliderView; // @synthesize sliderView=_sliderView;
...
@property(nonatomic) double sliderScale; // @synthesize sliderScale=_sliderScale;
...
- (void)changeToIndexWithoutAnimation:(unsigned long long)arg1;
- (void)animateChangeToIndex:(unsigned long long)arg1;
- (void)layoutSubviews;
- (void)forceNotBlockSelectedIndex:(long long)arg1 animated:(_Bool)arg2;
