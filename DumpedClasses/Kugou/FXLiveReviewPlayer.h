...
@class AVPlayer, AVPlayerItem, AVPlayerLayer, KGFileHolder, KGThemeLabel, NSString, PlaySlider, UIActivityIndicatorView, UIButton, UIImageView, UILabel;

@interface FXLiveReviewPlayer : UIView
{
    _Bool isReadToPlay;
    _Bool isFullScreen;
    _Bool isShowSetting;
    ...
    id <FXLiveReviewPlayerDelegate> _delegate;
    ...
    KGThemeLabel *_videoCurrentTimeLabel;
    KGThemeLabel *_videoLeftTimeLabel;
    UIImageView *_previewImageView;
    UIImageView *_previewLogoImageView;
    KGFileHolder *_mvFileHolder;
    long long _c_netstatus;
    struct CGRect _sourceFrame;
}

@property(nonatomic) long long c_netstatus; // @synthesize c_netstatus=_c_netstatus;
@property(nonatomic) _Bool isPausePlay; // @synthesize isPausePlay=_isPausePlay;
...
@property(retain, nonatomic) KGThemeLabel *videoLeftTimeLabel; // @synthesize videoLeftTimeLabel=_videoLeftTimeLabel;
@property(retain, nonatomic) KGThemeLabel *videoCurrentTimeLabel; // @synthesize videoCurrentTimeLabel=_videoCurrentTimeLabel;
...
@property(nonatomic) __weak id <FXLiveReviewPlayerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)configPlayer;
- (void)playMovieWithURLStr:(id)arg1 title:(id)arg2 previewImageName:(id)arg3;
...
- (id)themeLabelWithSize:(struct CGSize)arg1;
