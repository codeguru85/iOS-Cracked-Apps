...
@interface FXSLiveRoomSongListSong : FXBaseJSONModel
{
    long long _songId;
    ...
    NSString *_fansName;
    NSArray<Optional> *_giftUserLogos;
}

+ (id)keyMapper;
@property(retain, nonatomic) NSArray<Optional> *giftUserLogos; // @synthesize giftUserLogos=_giftUserLogos;
