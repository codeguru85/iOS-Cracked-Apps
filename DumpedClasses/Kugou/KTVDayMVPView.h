...
@interface KTVDayMVPView : UIView <KTVTableViewDataSource, KTVTableViewDelegate>
{
    KTVCommonTableViewRE *_tableView;
    id <KTVDayMVPViewDataSource> _dataSource;
    id <KTVDayMVPViewDelegate> _delegate;
    KGThemeLabel *_tipView;
}

@property(retain, nonatomic) KGThemeLabel *tipView; // @synthesize tipView=_tipView;
@property(nonatomic) __weak id <KTVDayMVPViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <KTVDayMVPViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
