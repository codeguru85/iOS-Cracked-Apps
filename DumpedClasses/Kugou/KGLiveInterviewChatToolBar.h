...
@interface KGLiveInterviewChatToolBar : UIView <HPGrowingTextViewDelegate, EmojiBoardViewDelegate>
{
    double _barHeight;
    ...
    int _curShowType;
    id <KGLiveInterviewChatToolBarDelegate> _delegate;
    UIView *_redDot;
    UIButton *_loveBtn;
    UIView *_mainView;
    UIButton *_giftBtn;
...
@property(nonatomic) __weak id <KGLiveInterviewChatToolBarDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
