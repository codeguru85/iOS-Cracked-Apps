...
@interface FAMobileLiveStarGiftConfigManager : NSObject
{
    _Bool _isEnd;
    NSTimer *_timer;
    ...
    id <FAMobileLiveStarGiftConfigManagerDelegate> _delegate;
}

+ (id)shareStarConfigMgr;
@property(nonatomic) __weak id <FAMobileLiveStarGiftConfigManagerDelegate> delegate; // @synthesize delegate=_delegate;
