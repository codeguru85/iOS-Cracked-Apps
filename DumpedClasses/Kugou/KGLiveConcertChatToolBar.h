...
@interface KGLiveConcertChatToolBar : UIView <HPGrowingTextViewDelegate, EmojiBoardViewDelegate>
{
    double _barHeight;
    ...
    int _curShowType;
    id <KGLiveConcertChatToolBarDelegate> _delegate;
    UIView *_redDot;
    UIButton *_loveBtn;
    UIView *_mainView;
    UIButton *_giftBtn;
...
@property(nonatomic) __weak id <KGLiveConcertChatToolBarDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (_Bool)istheFirstResbounder;
