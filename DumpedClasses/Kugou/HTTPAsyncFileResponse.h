...
@class NSData, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NewHTTPConnection;

@interface HTTPAsyncFileResponse : NSObject <NewHTTPResponse>
{
