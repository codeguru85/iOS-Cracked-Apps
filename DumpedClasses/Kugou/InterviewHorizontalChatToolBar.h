...
@interface InterviewHorizontalChatToolBar : UIView <HPGrowingTextViewDelegate, EmojiBoardViewDelegate>
{
    double _barHeight;
    ...
    int _curShowType;
    id <InterviewHorizontalChatToolBarDelegate> _delegate;
    UIView *_redDot;
    UIButton *_loveBtn;
    UIView *_mainView;
    UIButton *_giftBtn;
...
@property(nonatomic) __weak id <InterviewHorizontalChatToolBarDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
