...
@class AVPlayer, AVPlayerItem, AVPlayerLayer, FALivePlaySlider, NSString, UIActivityIndicatorView, UIButton, UILabel;

@interface FALiveAVVideoView : UIView
{
    _Bool isReadToPlay;
    _Bool isFullScreen;
    ...
    UILabel *_videoTitle;
    FALivePlaySlider *_playSlider;
    UILabel *_videoCurrentTimeLabel;
    UILabel *_videoLeftTimeLabel;
    UIButton *_volumnBtn;
    FALivePlaySlider *_volumnSlider;
    UIView *_volumnSliderBackView;
    UIActivityIndicatorView *_activityView;
    long long _videoTotalTime;
    long long _videoCurrentTime;
    UIButton *_barrageButton;
    id <FALiveAVVideoViewDelegate> _avPlayerViewControllerDelegate;
    NSString *_sourceUrl;
    long long _reconnectTimes;
    double _vHeight;
}

@property(nonatomic) _Bool isDefaultToSpeaker; // @synthesize isDefaultToSpeaker=_isDefaultToSpeaker;
...
@property(nonatomic) __weak id <FALiveAVVideoViewDelegate> avPlayerViewControllerDelegate; // @synthesize avPlayerViewControllerDelegate=_avPlayerViewControllerDelegate;
...
@property(retain, nonatomic) FALivePlaySlider *volumnSlider; // @synthesize volumnSlider=_volumnSlider;
...
@property(retain, nonatomic) FALivePlaySlider *playSlider; // @synthesize playSlider=_playSlider;
