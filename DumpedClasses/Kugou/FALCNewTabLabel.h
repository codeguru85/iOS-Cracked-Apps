...
@interface FALCNewTabLabel : UILabel
{
    ...
    id <FALCNewTabLabelDelegate> _delegate;
}

@property(nonatomic) __weak id <FALCNewTabLabelDelegate> delegate; // @synthesize delegate=_delegate;
