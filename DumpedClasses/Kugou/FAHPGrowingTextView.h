...
@class FAHPTextViewInternal, NSObject<FAHPGrowingTextViewDelegate>, NSString, UIColor, UIFont, UITextView;

@interface FAHPGrowingTextView : UIView <UITextViewDelegate>
{
    FAHPTextViewInternal *internalTextView;
    int minHeight;
    int maxHeight;
    ...
    NSObject<FAHPGrowingTextViewDelegate> *delegate;
...
@property NSObject<FAHPGrowingTextViewDelegate> *delegate; // @synthesize delegate;
