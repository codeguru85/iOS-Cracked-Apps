...
@class CLLocationManager, MAAngleIndicator, MAAnimationTaskManager, MAAnnotationContainerView, MACircle, MACompassView, MAIndoorInfo, MAIndoorView, MAMapRender, MAOverlayContainerView, MAScaleView, MATapPanToZoomGestureRecognizer, MAUserLocation, MAUserLocationRepresentation, MAViewRecycler, MAWorldMapTileOverlay, MapStatus, NSDictionary, NSMutableDictionary, NSNumber, NSString, UIImageView, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@interface MAMapView : UIView <UIGestureRecognizerDelegate, CLLocationManagerDelegate, MAMapEngineMapViewDelegate, MAMapRenderDelegate, MAOverlayContainerViewDelegate, MAAnnotationContainerViewDelegate, MACompassViewDelegate, MAMapLayerDelegate, MAIndoorViewDelegate>
{
    ...
    NSMutableDictionary *_initTaskDic;
...
- (void)setCustomMapStyle:(id)arg1 forMaptype:(long long)arg2;
