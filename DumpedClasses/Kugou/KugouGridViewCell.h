...
@interface KugouGridViewCell : UIView
{
    _Bool _editing;
    ...
    UIView *_contentViewStorge;
    struct CGSize _fullSize;
    struct CGPoint deleteButtonOffset;
}

@property(retain, nonatomic) UIView *contentViewStorge; // @synthesize contentViewStorge=_contentViewStorge;
