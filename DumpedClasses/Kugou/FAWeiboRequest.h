...
#import "MTWeiboRequestDelegate.h"

@class NSString;

@interface FAWeiboRequest : NSObject <MTWeiboRequestDelegate>
{
    id <FAWeiboRequestDelegate> _delegate;
}

+ (id)requestWithAccessToken:(id)arg1 url:(id)arg2 httpMethod:(id)arg3 params:(id)arg4 delegate:(id)arg5 withTag:(id)arg6;
@property(nonatomic) __weak id <FAWeiboRequestDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
