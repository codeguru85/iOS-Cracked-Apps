...
#import "FALiveSDPieLoopProgressView.h"

@class NSTimer;

@interface FALiveCountDownProgressView : FALiveSDPieLoopProgressView
{
    NSTimer *downCountTimer;
    long long _downCountBeginTime;
    long long _downCountCurrentTime;
    id <FALiveCountDownProgressViewDelegatge> _delegate;
}

@property(nonatomic) __weak id <FALiveCountDownProgressViewDelegatge> delegate; // @synthesize delegate=_delegate;
