...
#import "KGMVTableViewControllerDelegate.h"
#import "UITableViewDelegate.h"

@class KGMVControlView, KGViewController, NSMutableArray, NSString, UIImageView, UIView;

@interface KGMVControlViewController : NSObject <KGMVTableViewControllerDelegate, UITableViewDelegate>
{
    _Bool _isShowBottomMenu;
    _Bool _isFromLocalMusic;
    KGMVControlView *_controllerView;
    KGViewController *_controllerViewWithSingerNavi;
    NSMutableArray *_musicMenuArray;
    UIView *_menuBgView;
    id <KGMVTableViewAdapterOperateDelegate> _tableViewAdapterOperateDelegate;
    id <KGMVControlViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <KGMVControlViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <KGMVTableViewAdapterOperateDelegate> tableViewAdapterOperateDelegate; // @synthesize tableViewAdapterOperateDelegate=_tableViewAdapterOperateDelegate;
...
@property(readonly, nonatomic) KGMVControlView *controllerView; // @synthesize controllerView=_controllerView;
- (void).cxx_destruct;
