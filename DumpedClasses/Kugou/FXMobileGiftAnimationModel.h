...
@interface FXMobileGiftAnimationModel : FXBaseJSONModel
{
    _Bool _isGroup;
    NSString *_fromName;
    NSString *_toName;
...
@property(copy, nonatomic) NSString *giftPriceStr; // @synthesize giftPriceStr=_giftPriceStr;
@property(copy, nonatomic) NSString *isPileStr; // @synthesize isPileStr=_isPileStr;
@property(copy, nonatomic) NSString *flyStr; // @synthesize flyStr=_flyStr;
