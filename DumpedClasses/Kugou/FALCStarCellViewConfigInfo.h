...
@class FALCStarCellView, NSTimer;

@interface FALCStarCellViewConfigInfo : NSObject
{
    _Bool _isEnd;
    NSTimer *_timer;
    ...
    FALCStarCellView *_starCellView;
    id <FALCStarCellViewConfigInfoDelegate> _delegate;
}

+ (id)shareStarCellViewConfigInfo;
@property(nonatomic) __weak id <FALCStarCellViewConfigInfoDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak FALCStarCellView *starCellView; // @synthesize starCellView=_starCellView;
