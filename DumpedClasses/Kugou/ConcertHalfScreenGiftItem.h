...
@class KGLiveConcertGiftVM, UIImageView, UILabel;

@interface ConcertHalfScreenGiftItem : UIView
{
    _Bool _selected;
    KGLiveConcertGiftVM *_model;
...
@property(retain, nonatomic) KGLiveConcertGiftVM *model; // @synthesize model=_model;
- (void).cxx_destruct;
