...
@interface KGPlayTypeSelecterPopoverView : UIView <UITableViewDataSource, UITableViewDelegate>
{
...
@property(readonly, nonatomic) _Bool isOnAnimation; // @synthesize isOnAnimation=_isOnAnimation;
- (void).cxx_destruct;
...
- (void)registerNoti;
- (void)initWithPoint:(struct CGPoint)arg1 titles:(id)arg2 images:(id)arg3;
- (id)initWithStartShowPoint:(struct CGPoint)arg1;
