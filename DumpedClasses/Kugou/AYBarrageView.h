...
@class NSMutableArray, NSMutableSet, NSObject<AYBarrageViewDataSource>, NSTimer;

@interface AYBarrageView : UIView
{
    unsigned long long _playSubQueueMaxCount;
    NSObject<AYBarrageViewDataSource> *_dataSource;
...
@property(nonatomic) __weak NSObject<AYBarrageViewDataSource> *dataSource; // @synthesize dataSource=_dataSource;
...
- (void)insertItemAtFirst:(id)arg1;
