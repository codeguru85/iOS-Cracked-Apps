...
@class KGViewController, MusicControlView, NSMutableArray, NSString, PlayTypeListTableViewController, UIImageView, UIView;

@interface KGMusicControlViewController : NSObject <KGMusicTableViewControllDelegate, UITableViewDelegate>
{
    ...
    id <KGMusicControlViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <KGMusicControlViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
