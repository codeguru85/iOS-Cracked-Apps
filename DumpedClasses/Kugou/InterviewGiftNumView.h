...
@class InterviewGiftNumItem, NSArray, NSString, UIButton, UIScrollView;

@interface InterviewGiftNumView : UIView <UIScrollViewDelegate>
{
    id <InterviewGiftNumViewDelegate> _delegate;
    NSArray *_titles;
    UIScrollView *_giftContentView;
    UIButton *_cancleBtn;
    NSArray *_imgTitle;
    NSArray *_numArray;
    InterviewGiftNumItem *_selectedItem;
}

@property(retain, nonatomic) InterviewGiftNumItem *selectedItem; // @synthesize selectedItem=_selectedItem;
...
@property(nonatomic) __weak id <InterviewGiftNumViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)hide;
- (void)show;
