...
@interface KTVPromptFloatBoxView : UIView
{
    _Bool _bCanCloseBox;
    _Bool _bPanningSatate;
    id <KTVPromptFloatBoxViewDelegate> _delegate;
...
@property(nonatomic) __weak id <KTVPromptFloatBoxViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
