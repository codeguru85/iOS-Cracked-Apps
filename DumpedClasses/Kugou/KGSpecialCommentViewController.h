...
@interface KGSpecialCommentViewController : KGViewController <UITableViewDataSource, UITableViewDelegate, KGCommentTableViewCellDelegate, KGWidgetMenuViewDelegate, RefreshControlDelegate, KGViewControllerDelegate, KQInputViewDelegate>
{
    _Bool _isLoading;
    _Bool _hasMore;
