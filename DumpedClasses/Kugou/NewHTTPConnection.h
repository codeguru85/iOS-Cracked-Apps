...
@class GCDAsyncSocket, HTTPConfig, NSMutableArray, NSObject<NewHTTPResponse>, NSObject<OS_dispatch_queue>, NSString, NewHTTPMessage;

@interface NewHTTPConnection : NSObject
{
    NSObject<OS_dispatch_queue> *connectionQueue;
    GCDAsyncSocket *asyncSocket;
    HTTPConfig *config;
    _Bool started;
    NewHTTPMessage *request;
    unsigned int numHeaderLines;
    _Bool sentResponseHeaders;
    NSString *nonce;
    long long lastNC;
    NSObject<NewHTTPResponse> *httpResponse;
