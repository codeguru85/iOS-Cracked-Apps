...
@interface FAOHAttributedLabel : UILabel <UIGestureRecognizerDelegate, UIAppearance>
{
    ...
    id <FAOHAttributedLabelDelegate> _delegate;
...
@property(nonatomic) __weak id <FAOHAttributedLabelDelegate> delegate; // @synthesize delegate=_delegate;
