...
@class NSDictionary, NSMutableAttributedString, NSString, OHAttributedLabel;

@interface KGLChatMessageViewCell : KGLChatBaseCell <OHAttributedLabelDelegate>
{
    id <KGLChatMessageViewCellDelegate> _delegate;
...
@property(nonatomic) __weak id <KGLChatMessageViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)receiverAction;
- (void)senderAction;
