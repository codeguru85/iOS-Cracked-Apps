...
@interface FALCLiveItemEntity : FAModel
{
    _Bool _isHifi;
    _Bool _isSing;
    ...
    NSString *_corner;
    NSString *_cornerImg;
    NSString *_liveCornerImg;
}

@property(copy, nonatomic) NSString *liveCornerImg; // @synthesize liveCornerImg=_liveCornerImg;
...
@property(nonatomic) int isPk; // @synthesize isPk=_isPk;
