...
@interface KTVFDFriendSongView : UIView <KTVTableViewDataSource, KTVTableViewDelegate>
{
    KTVCommonTableViewRE *_tableView;
    id <KTVFDFriendSongViewDelegate> _delegate;
    id <KTVFDFriendSongViewDataSource> _dataSource;
}

@property(nonatomic) __weak id <KTVFDFriendSongViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property(nonatomic) __weak id <KTVFDFriendSongViewDelegate> delegate; // @synthesize delegate=_delegate;
