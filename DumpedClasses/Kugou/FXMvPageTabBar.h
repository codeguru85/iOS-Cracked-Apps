...
@class KGThemeLine, NSMutableArray, NSString;

@interface FXMvPageTabBar : UIView <UITabBarDelegate>
{
    long long _preSelectedItemTag;
    long long _selectIndex;
    NSMutableArray *_items;
    CDUnknownBlockType _tabarBlock;
    KGThemeLine *_lineTheme;
    UIView *_lineBottom;
    UIView *_contentView;
}
...
@property(retain, nonatomic) KGThemeLine *lineTheme; // @synthesize lineTheme=_lineTheme;
