...
@class FAThemeImageView, FAThemeView, NSString, UIImage, UIImageView, UILabel, UIView;

@interface FAMobileLiveWideClassCollectionCell : UICollectionViewCell
{
    NSString *_cellID;
    ...
    UILabel *_musicLabel;
    UILabel *_nameLabel;
    FAThemeImageView *_musicImageView;
    NSString *_headUrl;
...
@property(retain, nonatomic) FAThemeImageView *musicImageView; // @synthesize musicImageView=_musicImageView;
