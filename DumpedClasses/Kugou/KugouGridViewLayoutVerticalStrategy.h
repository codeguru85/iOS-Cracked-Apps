...
#import "KugouGridViewLayoutStrategyBase.h"

#import "KugouGridViewLayoutStrategy.h"

@class NSString;

@interface KugouGridViewLayoutVerticalStrategy : KugouGridViewLayoutStrategyBase <KugouGridViewLayoutStrategy>
{
