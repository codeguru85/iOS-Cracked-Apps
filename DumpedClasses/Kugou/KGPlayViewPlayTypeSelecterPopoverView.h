...
@class FXBlurView, NSArray, NSString, UIButton, UIColor, UITableView;

@interface KGPlayViewPlayTypeSelecterPopoverView : UIView <UITableViewDataSource, UITableViewDelegate>
{
