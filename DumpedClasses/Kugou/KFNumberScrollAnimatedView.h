...
@interface KFNumberScrollAnimatedView : UIView
{
    _Bool _isAscending;
    NSNumber *_value;
    UIColor *_textColor;
    ...
    NSMutableArray *_preNumbersText;
    NSMutableArray *_scrollLayers;
    NSMutableArray *_scrollLabels;
    NSNumber *_preValue;
}

@property(nonatomic) NSNumber *preValue; // @synthesize preValue=_preValue;
...
@property(retain, nonatomic) NSMutableArray *preNumbersText; // @synthesize preNumbersText=_preNumbersText;
