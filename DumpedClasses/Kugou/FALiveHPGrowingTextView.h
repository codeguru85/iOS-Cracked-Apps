...
@class FALiveHPTextViewInternal, NSObject<FALiveHPGrowingTextViewDelegate>, NSString, UIColor, UIFont, UITextView;

@interface FALiveHPGrowingTextView : UIView <UITextViewDelegate>
{
    FALiveHPTextViewInternal *internalTextView;
    int minHeight;
    int maxHeight;
    ...
    NSObject<FALiveHPGrowingTextViewDelegate> *delegate;
    UIFont *font;
    UIColor *textColor;
    double _textMinHeight;
}

@property(nonatomic) double textMinHeight; // @synthesize textMinHeight=_textMinHeight;
...
@property(nonatomic) __weak NSObject<FALiveHPGrowingTextViewDelegate> *delegate; // @synthesize delegate;
