...
@class NSArray<FASearchLiveSingerModel>, NSString;

@interface FASearchLiveModel : FAModel
{
    ...
    NSArray<FASearchLiveSingerModel> *_singer;
    long long _playNum;
    long long _roomId;
...
@property(nonatomic) long long mobileCover; // @synthesize mobileCover=_mobileCover;
...
@property(retain, nonatomic) NSArray<FASearchLiveSingerModel> *singer; // @synthesize singer=_singer;
