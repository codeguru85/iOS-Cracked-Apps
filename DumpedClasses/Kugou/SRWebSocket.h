...
@class NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest, SRIOConsumerPool;
