...
@class EmojiBoardView, HPGrowingTextView, KGLLiveActivityVM, NSMutableArray, NSString, UIButton, UILabel;

@interface KGLLiveRoomBottomView : UIView <HPGrowingTextViewDelegate, EmojiBoardViewDelegate>
{
    double _barHeight;
    ...
    int _curShowType;
    id <KGLLiveRoomBottomViewDelegate> _delegate;
    UIView *_redDot;
    UIButton *_loveBtn;
    UIView *_mainView;
    KGLLiveActivityVM *_giftBtnModel;
    UIView *_textBgView;
...
@property(retain, nonatomic) KGLLiveActivityVM *giftBtnModel; // @synthesize giftBtnModel=_giftBtnModel;
...
@property(nonatomic) __weak id <KGLLiveRoomBottomViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
