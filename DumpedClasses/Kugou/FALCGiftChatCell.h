...
@interface FALCGiftChatCell : FALCBaseChatCell <FAOHAttributedLabelDelegate>
{
    id <FALCChatGiftViewCellDelegate> _delegate;
    FALCMessage *_fxMsg;
    NSDictionary *_msgDic;
    FAOHAttributedLabel *_attributedLabel;
    FAOHAttributedLabel *_receiveLabel;
...
+ (double)giftInfoCellHeight:(id)arg1;
...
@property(retain, nonatomic) FAOHAttributedLabel *receiveLabel; // @synthesize receiveLabel=_receiveLabel;
...
@property(nonatomic) __weak id <FALCChatGiftViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)receiverAction;
- (void)senderAction;
