...
@interface FXMobileMultiLineKrcView : UIView <UITableViewDataSource, UITableViewDelegate>
{
    ...
    UIImageView *bgView;
    id <FXMobilePanKrcViewDelegate> krcDelegate;
...
@property(nonatomic) __weak id <FXMobilePanKrcViewDelegate> krcDelegate; // @synthesize krcDelegate;
