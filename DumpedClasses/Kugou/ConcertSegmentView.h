...
@interface ConcertSegmentView : UIView
{
    _Bool _isFullScreen;
    id <ConcertSegmentViewDelegate> _delegate;
    UIButton *_one;
    UIButton *_two;
    UIButton *_three;
    UIButton *_four;
...
@property(nonatomic) __weak id <ConcertSegmentViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)resetBtnName;
- (void)selectOne;
