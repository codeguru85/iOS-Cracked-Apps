...
@interface KTVDownLoadAttachCell : UITableViewCell
{
    _Bool _showDetailMenu;
    id <KTVDownLoadAttachCellDelegate> _delegate;
...
@property(nonatomic) __weak id <KTVDownLoadAttachCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)dealloc;
