...
@interface FALCChatGiftViewCell : FALCChatBaseCell <FAOHAttributedLabelDelegate>
{
    id <FAChatGiftViewCellDelegate> _delegate;
    FALCMessage *_fxMsg;
...
@property(nonatomic) __weak id <FAChatGiftViewCellDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)receiverAction;
- (void)senderAction;
