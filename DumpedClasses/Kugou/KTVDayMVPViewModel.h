...
@interface KTVDayMVPViewModel : KFViewModelObject
{
    _Bool _isAcceptRequesting;
    int _pageNo;
    NSMutableArray *_dayMvpList;
...
@property(retain, nonatomic) NSMutableArray *dayMvpList; // @synthesize dayMvpList=_dayMvpList;
@property(nonatomic) int pageNo; // @synthesize pageNo=_pageNo;
- (void).cxx_destruct;
- (id)infoList;
- (id)dayMVPInfoAtIndex:(long long)arg1;
- (long long)numberOfDayMVP;
- (void)updateRecommendOpus;
- (void)loadMore;
- (void)update;
- (id)init;
