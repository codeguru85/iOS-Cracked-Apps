...
@interface KugouGridViewLayoutStrategyBase : NSObject
{
    int _type;
...
- (void)setupItemSize:(struct CGSize)arg1 andItemSpacing:(long long)arg2 withMinEdgeInsets:(struct UIEdgeInsets)arg3 andCenteredGrid:(_Bool)arg4 withTopPadding:(double)arg5 andBottomPadding:(double)arg6;
