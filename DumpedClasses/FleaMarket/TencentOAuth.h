...
@property(nonatomic) id <TencentSessionDelegate> sessionDelegate; // @dynamic sessionDelegate;
...
@property(copy, nonatomic) NSString *localAppId; // @dynamic localAppId;
@property(retain, nonatomic) NSMutableDictionary *loginDict; // @dynamic loginDict;
@property(retain, nonatomic) NSMutableDictionary *openIdDict; // @dynamic openIdDict;
@property(copy, nonatomic) NSDictionary *passData; // @dynamic passData;
@property(retain, nonatomic) NSArray *permissions; // @dynamic permissions;
@property(retain, nonatomic) TCOSDKReachability *reachHost; // @dynamic reachHost;
