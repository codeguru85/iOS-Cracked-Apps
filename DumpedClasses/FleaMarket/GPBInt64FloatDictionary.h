...
+ (id)dictionaryWithValues:(const float *)arg1 forKeys:(const long long *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(float)arg1 forKey:(long long)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(long long)arg1;
- (void)setValue:(float)arg1 forKey:(long long)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (_Bool)valueForKey:(long long)arg1 value:(float *)arg2;
...
- (id)initWithValues:(const float *)arg1 forKeys:(const long long *)arg2 count:(unsigned long long)arg3;
- (id)init;
