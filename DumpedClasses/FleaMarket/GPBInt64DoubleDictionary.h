...
+ (id)dictionaryWithValues:(const double *)arg1 forKeys:(const long long *)arg2 count:(unsigned long long)arg3;
...
- (_Bool)valueForKey:(long long)arg1 value:(double *)arg2;
...
- (id)initWithValues:(const double *)arg1 forKeys:(const long long *)arg2 count:(unsigned long long)arg3;
- (id)init;
