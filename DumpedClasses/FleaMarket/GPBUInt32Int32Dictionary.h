...
+ (id)dictionaryWithValues:(const int *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(int)arg1 forKey:(unsigned int)arg2;
+ (id)dictionary;
- (void)removeAll;
...
- (id)initWithValues:(const int *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned long long)arg3;
- (id)init;
