...
@interface ABAuthContext : NSObject <ABDetectListener, ABFaceDetectCallback>
{
    ...
    id <ABFaceDialogCallback> _faceDialogCallback;
...
+ (void)endLivenessDetect:(id)arg1;
+ (void)restartLivenessDetect:(id)arg1;
+ (void)showRetryDialog:(id)arg1 withCallback:(id)arg2;
...
@property(retain) id <ABFaceDialogCallback> faceDialogCallback; // @synthesize faceDialogCallback=_faceDialogCallback;
