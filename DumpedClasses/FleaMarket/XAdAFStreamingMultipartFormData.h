...
#import "XAdAFMultipartFormData.h"

@class NSMutableURLRequest, NSString, XAdAFMultipartBodyStream;

@interface XAdAFStreamingMultipartFormData : NSObject <XAdAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    XAdAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) XAdAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
