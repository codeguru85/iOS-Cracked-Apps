...
+ (id)dictionaryWithValues:(const int *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(int)arg1 forKey:(id)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(id)arg1;
- (void)setValue:(int)arg1 forKey:(id)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (_Bool)valueForKey:(id)arg1 value:(int *)arg2;
...
- (id)initWithValues:(const int *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
- (id)init;
