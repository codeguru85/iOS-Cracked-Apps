...
@class CAAnimationGroup, LOTCircleShapeLayer, LOTShapeCircle, LOTShapeFill, LOTShapeStroke, LOTShapeTransform, LOTShapeTrimPath;
...
- (id)initWithEllipseShape:(id)arg1 fill:(id)arg2 stroke:(id)arg3 trim:(id)arg4 transform:(id)arg5 withLayerDuration:(double)arg6;
