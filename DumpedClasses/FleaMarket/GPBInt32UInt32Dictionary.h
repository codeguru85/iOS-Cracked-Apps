...
+ (id)dictionaryWithValues:(const unsigned int *)arg1 forKeys:(const int *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(unsigned int)arg1 forKey:(int)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(int)arg1;
- (void)setValue:(unsigned int)arg1 forKey:(int)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (_Bool)valueForKey:(int)arg1 value:(unsigned int *)arg2;
...
- (id)initWithValues:(const unsigned int *)arg1 forKeys:(const int *)arg2 count:(unsigned long long)arg3;
- (id)init;
