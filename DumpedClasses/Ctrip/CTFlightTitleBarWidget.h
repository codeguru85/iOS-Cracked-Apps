...
@class CTFlightTitleBarWidgetWrapper, NSMutableArray, UIView;

@interface CTFlightTitleBarWidget : CTRootView
{
    int _transitionAnimation;
    int _collectAction;
    UIView *_contentView;
    CTFlightTitleBarWidgetWrapper *_widgetWrapper;
    NSMutableArray *_presentedWidgets;
    CTFlightTitleBarWidget *_presentingWidget;
}

+ (id)nameOfCollectAction:(int)arg1;
+ (id)widgetWithTitle:(id)arg1;
@property(readonly, nonatomic) __weak CTFlightTitleBarWidget *presentingWidget; // @synthesize presentingWidget=_presentingWidget;
...
@property(retain, nonatomic) CTFlightTitleBarWidgetWrapper *widgetWrapper; // @synthesize widgetWrapper=_widgetWrapper;
