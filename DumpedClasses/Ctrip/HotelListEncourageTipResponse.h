...
@interface HotelListEncourageTipResponse : CTBusinessBean
{
    int _result;
    ResponseHead *_head;
...
@property(retain, nonatomic) NSMutableArray *placeHolderList; // @synthesize placeHolderList=_placeHolderList;
@property(copy, nonatomic) NSString *descTips; // @synthesize descTips=_descTips;
