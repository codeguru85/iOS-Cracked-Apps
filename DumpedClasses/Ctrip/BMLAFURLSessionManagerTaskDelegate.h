...
@class BMLAFURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface BMLAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    BMLAFURLSessionManager *_manager;
...
@property(nonatomic) __weak BMLAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
