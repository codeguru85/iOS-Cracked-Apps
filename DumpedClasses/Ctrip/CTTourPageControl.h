...
@interface CTTourPageControl : UIControl
{
    ...
    id <CTTourPageControlDelegate> _delegate;
...
@property(nonatomic) id <CTTourPageControlDelegate> delegate; // @synthesize delegate=_delegate;
