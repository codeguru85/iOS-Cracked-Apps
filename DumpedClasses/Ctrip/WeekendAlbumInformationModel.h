...
@interface WeekendAlbumInformationModel : CTBusinessBean
{
    long long _albumId;
    NSString *_albumTypeName;
    NSString *_title;
    NSString *_subtitle;
    NSString *_image;
    NSString *_jumpUrl;
...
@property(copy, nonatomic) NSString *albumTypeName; // @synthesize albumTypeName=_albumTypeName;
