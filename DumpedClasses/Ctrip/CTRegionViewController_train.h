...
@interface CTRegionViewController_train : CTRootViewController <CTRegionPickerDataSourceDelegate, UITableViewDataSource, UITableViewDelegate, CTLocationDelegate>
{
    ...
    id <CTRegionViewController_trainDelegate> _delegate;
...
@property(nonatomic) id <CTRegionViewController_trainDelegate> delegate; // @synthesize delegate=_delegate;
