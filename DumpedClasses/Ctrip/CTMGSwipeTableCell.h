...
@class CADisplayLink, MGSwipeAnimationData, MGSwipeButtonsView, MGSwipeExpansionSettings, MGSwipeSettings, MGSwipeTableInputOverlay, NSArray, NSMutableSet, UIColor, UIImageView, UIPanGestureRecognizer, UITableView, UITapGestureRecognizer, UIView;

@interface CTMGSwipeTableCell : UITableViewCell
{
