...
{
    NSMutableDictionary *_keychainItemDictionary;
...
@property(retain, nonatomic) NSMutableDictionary *keychainItemDictionary; // @synthesize keychainItemDictionary=_keychainItemDictionary;
- (void).cxx_destruct;
