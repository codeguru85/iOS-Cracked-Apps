...
@interface CommentSubmitKeywordsResponse : CTBusinessBean
{
    int _result;
    int _CommentCount;
    ResponseHead *_head;
    NSString *_resultMessage;
    NSMutableArray *_submitKeywordsList;
}

@property(nonatomic) int CommentCount; // @synthesize CommentCount=_CommentCount;
@property(retain, nonatomic) NSMutableArray *submitKeywordsList; // @synthesize submitKeywordsList=_submitKeywordsList;
