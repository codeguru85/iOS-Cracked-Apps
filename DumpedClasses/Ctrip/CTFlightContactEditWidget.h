...
@interface CTFlightContactEditWidget : CTFlightTableViewWidget
{
    _Bool _newCreated;
    int _serviceAreaType;
    NSMutableArray *arrTableCells;
    id <CTFlightContactEditWidgetDelegate> _delegate;
    id _node;
}
...
@property(nonatomic) __weak id <CTFlightContactEditWidgetDelegate> delegate; // @synthesize delegate=_delegate;
