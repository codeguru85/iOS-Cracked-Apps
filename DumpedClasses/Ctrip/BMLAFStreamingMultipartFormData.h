...
#import "BMLAFMultipartFormData.h"

@class BMLAFMultipartBodyStream, NSMutableURLRequest, NSString;

@interface BMLAFStreamingMultipartFormData : NSObject <BMLAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    BMLAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) BMLAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
