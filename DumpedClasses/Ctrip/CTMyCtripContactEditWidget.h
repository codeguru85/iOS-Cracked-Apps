...
#import "CTMyCtripTableViewWidget.h"

@class NSMutableArray;

@interface CTMyCtripContactEditWidget : CTMyCtripTableViewWidget
{
    _Bool _newCreated;
    int _serviceAreaType;
    NSMutableArray *arrTableCells;
    id <CTMyCtripContactEditWidgetDelegate> _delegate;
    id _node;
}
...
@property(nonatomic) __weak id <CTMyCtripContactEditWidgetDelegate> delegate; // @synthesize delegate=_delegate;
