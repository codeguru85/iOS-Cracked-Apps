...
@interface FlightCityModel : CTBusinessBean
{
    int _cityDataID;
    int _cityID;
    int _countryEnum;
    ...
    NSString *_recordingCityCode;
}

@property(copy, nonatomic) NSString *recordingCityCode; // @synthesize recordingCityCode=_recordingCityCode;
