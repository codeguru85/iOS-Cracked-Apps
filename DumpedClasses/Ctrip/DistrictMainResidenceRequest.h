...
@interface DistrictMainResidenceRequest : CTBusinessBean <NSCoding>
{
    int districtId;
    NSString *latitude;
    NSString *longitude;
    ClientScreenDataModel *screenDataModel;
    NSString *districtIdsHistory;
}

@property(copy, nonatomic) NSString *districtIdsHistory; // @synthesize districtIdsHistory;
