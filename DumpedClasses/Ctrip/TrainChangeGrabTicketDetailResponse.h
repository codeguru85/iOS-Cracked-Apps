...
@interface TrainChangeGrabTicketDetailResponse : CTBusinessBean
{
    NSString *message;
    int retCode;
    NSString *grabTicketCheats;
...
@property(copy, nonatomic) NSString *grabTicketCheats; // @synthesize grabTicketCheats;
