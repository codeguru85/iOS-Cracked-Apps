...
@interface HotelFireflyRecommendResponse : CTBusinessBean
{
    int _result;
    NSString *_resultMessage;
    NSMutableArray *_fireflyInfoList;
    NSString *_testResult;
}

@property(copy, nonatomic) NSString *testResult; // @synthesize testResult=_testResult;
@property(retain, nonatomic) NSMutableArray *fireflyInfoList; // @synthesize fireflyInfoList=_fireflyInfoList;
