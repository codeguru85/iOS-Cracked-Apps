...
@interface CTIntFlightOrderDetailTransferCell : CTCustomeGroupTableViewCell
{
    id <CTIntFlightOrderDetailTransferCellDelegate> _orderDetailCellDelegate;
    ...
    CTAutoResizeLabel *_labelFlytime;
    ...
    NSLayoutConstraint *_cnslabelFlytimeHeight;
    NSLayoutConstraint *_cnsAirCraftTop;
    NSLayoutConstraint *_departureTerminalWidth;
    NSLayoutConstraint *_departureTerminalHeight;
    NSLayoutConstraint *_departureTerminalTopHeight;
    NSLayoutConstraint *_imagejourneryHeight;
    NSLayoutConstraint *_arriveTerminalHeight;
    NSLayoutConstraint *_arriveTerminalWidth;
    NSLayoutConstraint *_arriveTerminalTopHeight;
    NSLayoutConstraint *_bottomHeight;
}

+ (double)setupOrderDetailCell:(id)arg1 withModel:(id)arg2 flightIndex:(int)arg3 totalCount:(int)arg4;
@property(retain, nonatomic) NSLayoutConstraint *bottomHeight; // @synthesize bottomHeight=_bottomHeight;
@property(retain, nonatomic) NSLayoutConstraint *arriveTerminalTopHeight; // @synthesize arriveTerminalTopHeight=_arriveTerminalTopHeight;
@property(retain, nonatomic) NSLayoutConstraint *arriveTerminalWidth; // @synthesize arriveTerminalWidth=_arriveTerminalWidth;
@property(retain, nonatomic) NSLayoutConstraint *arriveTerminalHeight; // @synthesize arriveTerminalHeight=_arriveTerminalHeight;
@property(retain, nonatomic) NSLayoutConstraint *imagejourneryHeight; // @synthesize imagejourneryHeight=_imagejourneryHeight;
...
@property(retain, nonatomic) NSLayoutConstraint *departureTerminalHeight; // @synthesize departureTerminalHeight=_departureTerminalHeight;
@property(retain, nonatomic) NSLayoutConstraint *departureTerminalWidth; // @synthesize departureTerminalWidth=_departureTerminalWidth;
@property(nonatomic) __weak NSLayoutConstraint *cnsAirCraftTop; // @synthesize cnsAirCraftTop=_cnsAirCraftTop;
@property(nonatomic) __weak NSLayoutConstraint *cnslabelFlytimeHeight; // @synthesize cnslabelFlytimeHeight=_cnslabelFlytimeHeight;
...
@property(retain, nonatomic) CTAutoResizeLabel *labelFlytime; // @synthesize labelFlytime=_labelFlytime;
...
@property(nonatomic) __weak id <CTIntFlightOrderDetailTransferCellDelegate> orderDetailCellDelegate; // @synthesize orderDetailCellDelegate=_orderDetailCellDelegate;
- (void).cxx_destruct;
