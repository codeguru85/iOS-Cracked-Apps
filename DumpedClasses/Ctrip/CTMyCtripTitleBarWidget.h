...
@class CTMyCtripTitleBarWidgetWrapper, NSMutableArray, UIView;

@interface CTMyCtripTitleBarWidget : CTRootView
{
    int _transitionAnimation;
    int _collectAction;
    UIView *_contentView;
    CTMyCtripTitleBarWidgetWrapper *_widgetWrapper;
    NSMutableArray *_presentedWidgets;
    CTMyCtripTitleBarWidget *_presentingWidget;
}

+ (id)nameOfCollectAction:(int)arg1;
+ (id)widgetWithTitle:(id)arg1;
@property(readonly, nonatomic) __weak CTMyCtripTitleBarWidget *presentingWidget; // @synthesize presentingWidget=_presentingWidget;
...
@property(retain, nonatomic) CTMyCtripTitleBarWidgetWrapper *widgetWrapper; // @synthesize widgetWrapper=_widgetWrapper;
