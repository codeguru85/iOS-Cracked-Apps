...
@class BMLAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface BMLAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    BMLAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) BMLAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
