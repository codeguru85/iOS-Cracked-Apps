...
@interface CTSCarCell : CTSCustomActionCell
{
    UIView *_realContentView;
    UILabel *_titleLabel;
    CTImageView *_iconImageView;
    CTImageView *_vehicleImageView;
    UILabel *_tipLabel;
    UILabel *_timeLabel;
...
@property(nonatomic) __weak CTImageView *vehicleImageView; // @synthesize vehicleImageView=_vehicleImageView;
