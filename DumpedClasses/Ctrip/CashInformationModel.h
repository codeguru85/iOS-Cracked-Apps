...
@interface CashInformationModel : CTBusinessBean
{
...
@property(nonatomic) int receiveSite; // @synthesize receiveSite;
@property(nonatomic) int receiveBranch; // @synthesize receiveBranch;
