...
@class CTTitleBarWidgetWrapper_old, NSMutableArray, UIView;

@interface CTTitleBarWidget_old : CTRootView
{
    int _transitionAnimation;
    int _collectAction;
    UIView *_contentView;
    CTTitleBarWidgetWrapper_old *_widgetWrapper;
    NSMutableArray *_presentedWidgets;
    CTTitleBarWidget_old *_presentingWidget;
}

+ (id)nameOfCollectAction:(int)arg1;
+ (id)widgetWithTitle:(id)arg1;
@property(readonly, nonatomic) __weak CTTitleBarWidget_old *presentingWidget; // @synthesize presentingWidget=_presentingWidget;
...
@property(retain, nonatomic) CTTitleBarWidgetWrapper_old *widgetWrapper; // @synthesize widgetWrapper=_widgetWrapper;
