...
@class NSMutableArray, NSString, ParsedHotelInformationModel, ParsedMemoModel, PreRecommendInformationModel;

@interface ParseAddSmartTripV2Response : CTBusinessBean
{
    int _result;
    ...
    ParsedMemoModel *_parsedMemoModel;
    ParsedHotelInformationModel *_parsedHotelInfoModel;
...
@property(retain, nonatomic) ParsedHotelInformationModel *parsedHotelInfoModel; // @synthesize parsedHotelInfoModel=_parsedHotelInfoModel;
@property(retain, nonatomic) ParsedMemoModel *parsedMemoModel; // @synthesize parsedMemoModel=_parsedMemoModel;
