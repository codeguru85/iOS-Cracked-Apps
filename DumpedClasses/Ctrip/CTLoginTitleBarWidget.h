...
@class CTLoginTitleBarWidgetWrapper, NSMutableArray, UIView;

@interface CTLoginTitleBarWidget : CTRootView
{
    int _transitionAnimation;
    int _collectAction;
    UIView *_contentView;
    CTLoginTitleBarWidgetWrapper *_widgetWrapper;
    NSMutableArray *_presentedWidgets;
    CTLoginTitleBarWidget *_presentingWidget;
}

+ (id)nameOfCollectAction:(int)arg1;
+ (id)widgetWithTitle:(id)arg1;
@property(readonly, nonatomic) __weak CTLoginTitleBarWidget *presentingWidget; // @synthesize presentingWidget=_presentingWidget;
...
@property(retain, nonatomic) CTLoginTitleBarWidgetWrapper *widgetWrapper; // @synthesize widgetWrapper=_widgetWrapper;
