...
@class CTTitleBarWidgetWrapper_train, NSMutableArray, UIView;

@interface CTTitleBarWidget_train : CTRootView
{
    int _transitionAnimation;
    int _collectAction;
    UIView *_contentView;
    CTTitleBarWidgetWrapper_train *_widgetWrapper;
    NSMutableArray *_presentedWidgets;
    CTTitleBarWidget_train *_presentingWidget;
}

+ (id)nameOfCollectAction:(int)arg1;
+ (id)widgetWithTitle:(id)arg1;
@property(readonly, nonatomic) __weak CTTitleBarWidget_train *presentingWidget; // @synthesize presentingWidget=_presentingWidget;
...
@property(retain, nonatomic) CTTitleBarWidgetWrapper_train *widgetWrapper; // @synthesize widgetWrapper=_widgetWrapper;
