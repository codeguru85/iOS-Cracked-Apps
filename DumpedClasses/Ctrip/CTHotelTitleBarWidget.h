...
@class CTHotelTitleBarWidgetWrapper, NSMutableArray, UIView;

@interface CTHotelTitleBarWidget : CTRootView
{
    int _transitionAnimation;
    UIView *_contentView;
    CTHotelTitleBarWidgetWrapper *_widgetWrapper;
    NSMutableArray *_presentedWidgets;
    CTHotelTitleBarWidget *_presentingWidget;
}

+ (id)widgetWithTitle:(id)arg1;
@property(readonly, nonatomic) __weak CTHotelTitleBarWidget *presentingWidget; // @synthesize presentingWidget=_presentingWidget;
...
@property(retain, nonatomic) CTHotelTitleBarWidgetWrapper *widgetWrapper; // @synthesize widgetWrapper=_widgetWrapper;
