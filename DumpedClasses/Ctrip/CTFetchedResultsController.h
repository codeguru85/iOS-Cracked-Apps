...
@interface CTFetchedResultsController : NSObject
{
    NSArray *_oldObjects;
    NSArray *_oldIndexPaths;
    id <CTFetchedResultsControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <CTFetchedResultsControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
