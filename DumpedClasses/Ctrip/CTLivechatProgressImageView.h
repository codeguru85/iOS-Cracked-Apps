...
@interface CTLivechatProgressImageView : CTImageView
{
    double _scale;
    id <CTLivechatProgressImageViewDelegate> _progressDelegate;
    UIView *_maskView;
    NSTimer *_maskTimer;
}
...
@property(nonatomic) __weak id <CTLivechatProgressImageViewDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
