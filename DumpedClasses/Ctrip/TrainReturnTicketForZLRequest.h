...
@interface TrainReturnTicketForZLRequest : CTBusinessBean
{
    int serviceVersion;
    int oldOrderId;
    long long orderId;
    ...
    NSString *orderDate;
    NSMutableArray *returnTicketInfoList;
}

+ (id)modelContainerPropertyGenericClass;
@property(retain, nonatomic) NSMutableArray *returnTicketInfoList; // @synthesize returnTicketInfoList;
