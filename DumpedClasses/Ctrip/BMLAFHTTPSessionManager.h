...
#import "BMLAFURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class BMLAFHTTPRequestSerializer<BMLAFURLRequestSerialization>, BMLAFHTTPResponseSerializer<BMLAFURLResponseSerialization>, NSURL;

@interface BMLAFHTTPSessionManager : BMLAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) BMLAFHTTPResponseSerializer<BMLAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
