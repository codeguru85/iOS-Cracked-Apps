...
@interface CTMyCtripInvoiceTitleWidget : CTRootViewController
{
    _Bool _isSuccess;
    CustomerUserInvoiceModel *_selectedInvoiceTitleModel;
    id <CTMyCtripInvoiceTitleWidgetDelegate> _delegate;
...
@property(nonatomic) __weak id <CTMyCtripInvoiceTitleWidgetDelegate> delegate; // @synthesize delegate=_delegate;
