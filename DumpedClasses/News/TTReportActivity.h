...
@class NSString, TTReportContentItem, UIViewController;

@interface TTReportActivity : NSObject <TTActivityProtocol>
{
    TTReportContentItem *_contentItem;
}

+ (void)load;
@property(retain, nonatomic) TTReportContentItem *contentItem; // @synthesize contentItem=_contentItem;
- (void).cxx_destruct;
