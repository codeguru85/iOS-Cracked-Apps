...
@interface FLEXFileBrowserTableViewController : UITableViewController <FLEXFileBrowserFileOperationControllerDelegate, UISearchDisplayDelegate, FLEXFileBrowserSearchOperationDelegate>
{
    NSString *_path;
    NSArray *_childPaths;
