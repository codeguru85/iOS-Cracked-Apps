...
@interface PbRequest : PBGeneratedMessage <GeneratedMessageProtocol>
{
    unsigned int hasRequest_:1;
    NSString *request;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSString *request; // @synthesize request;
- (void).cxx_destruct;
