...
- (void).cxx_destruct;
- (id)initWithAvatar:(id)arg1 title:(id)arg2 showBorder:(_Bool)arg3 block:(CDUnknownBlockType)arg4;
- (id)initWithAvatar:(id)arg1 title:(id)arg2 showBorder:(_Bool)arg3;
