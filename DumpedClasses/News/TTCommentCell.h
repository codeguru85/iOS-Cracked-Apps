...
@class DetailActionRequestManager, ExploreAvatarView, TTCommentReplyListView, TTUserInfoView, UIButton, UILabel, UIView;

@interface TTCommentCell : SSThemedTableViewCell
{
    _Bool _hasShown;
