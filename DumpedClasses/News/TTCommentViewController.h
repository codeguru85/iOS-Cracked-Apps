...
@class NSIndexPath, NSString, SSThemedTableView, SSThemedView, TTCommentEmptyView, TTCommentViewModel;

@interface TTCommentViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate, TTCommentEmptyViewDelegate, ExploreDetailBaseADViewDelegate, TTCommentCellDelegate, ExploreMomentListCellUserActionItemDelegate, SSImpressionProtocol, TTCommentFooterCellDelegate, TTCommentViewControllerProtocol>
{
