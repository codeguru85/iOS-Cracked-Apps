...
@interface ReadMessageIds : PBGeneratedMessage <GeneratedMessageProtocol>
{
    NSMutableArray *readMessageIdArray;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSMutableArray *readMessageIdArray; // @synthesize readMessageIdArray;
- (void).cxx_destruct;
...
@property(readonly) NSArray *readMessageId; // @dynamic readMessageId;
- (id)defaultInstance;
- (id)init;
