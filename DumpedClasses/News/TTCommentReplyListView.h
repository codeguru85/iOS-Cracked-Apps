...
@interface TTCommentReplyListView : SSThemedView <UITableViewDataSource, UITableViewDelegate>
{
    SSThemedView *_wrapper;
    SSThemedTableView *_replyTableView;
    id <TTCommentModelProtocol> _toComment;
    NSArray *_replyArr;
...
@property(retain, nonatomic) id <TTCommentModelProtocol> toComment; // @synthesize toComment=_toComment;
