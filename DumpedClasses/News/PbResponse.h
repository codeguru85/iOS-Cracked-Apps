...
@interface PbResponse : PBGeneratedMessage <GeneratedMessageProtocol>
{
    unsigned int hasResponse_:1;
    NSString *response;
}
...
+ (id)defaultInstance;
+ (void)initialize;
@property(retain) NSString *response; // @synthesize response;
- (void).cxx_destruct;
...
- (id)defaultInstance;
- (id)init;
- (void)setHasResponse:(_Bool)arg1;
- (_Bool)hasResponse;
