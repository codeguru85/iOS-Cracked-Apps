...
@interface TTLiveFoldableLayout : NSObject <TTFoldableLayoutProtocol>
{
    ...
    _Bool _unlockPushToFolded;
    _Bool _lockFoldOneOpen;
    _Bool _headerViewFolded;
    _Bool _animationDisable;
    UIView *_headerView;
    UIView *_tabView;
...
@property(nonatomic) _Bool animationDisable; // @synthesize animationDisable=_animationDisable;
...
@property(nonatomic) _Bool lockFoldOneOpen; // @synthesize lockFoldOneOpen=_lockFoldOneOpen;
@property(nonatomic) _Bool unlockPushToFolded; // @synthesize unlockPushToFolded=_unlockPushToFolded;
