...
#import "WDPostQuestionInputTagsCollectionCellDelegate.h"

@class NSString, WDModifyTagViewModel, WDPostQuestionViewModel;

@interface WDPostQuestionTagsCollectionView : UICollectionView <UICollectionViewDataSource, UICollectionViewDelegate, WDPostQuestionInputTagsCollectionCellDelegate>
{
...
- (void).cxx_destruct;
- (void)postQuestionInputTagsCollectionCellDeleteButtonTapped:(id)arg1;
