...
@class NSMutableArray, SSThemedView, WDDetailNatantRelateArticleGroupViewModel;

@interface WDDetailNatantRelateArticleGroupView : TTDetailNatantViewBase
{
    NSMutableArray *_items;
    WDDetailNatantRelateArticleGroupViewModel *_viewModel;
...
@property(retain, nonatomic) WDDetailNatantRelateArticleGroupViewModel *viewModel; // @synthesize viewModel=_viewModel;
