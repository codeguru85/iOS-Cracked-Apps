...
@class HTSVideoPlayTextViewInternal, NSObject<HTSVideoPlayGrowingTextViewDelegate>, NSString, UIColor, UIFont, UITextView;
...
@interface HTSVideoPlayGrowingTextView : SSThemedView <UITextViewDelegate>
{
    ...
    NSObject<HTSVideoPlayGrowingTextViewDelegate> *delegate;
...
@property __weak NSObject<HTSVideoPlayGrowingTextViewDelegate> *delegate; // @synthesize delegate;
