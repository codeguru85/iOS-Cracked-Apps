...
@interface WDListNofityBarView : SSThemedView <ErrorToastProtocal>
{
    _Bool _userClose;
    _Bool _needPadPadding;
...
@property(nonatomic) _Bool needPadPadding; // @synthesize needPadPadding=_needPadPadding;
