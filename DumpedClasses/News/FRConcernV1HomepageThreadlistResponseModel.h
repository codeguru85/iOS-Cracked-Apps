...
@class FRLoginUserInfoStructModel, FRTipsStructModel, NSArray<FRGeneralThreadStructModel><Optional>, NSArray<FRGroupStructModel><Optional>, NSNumber, NSString<Optional>;

@interface FRConcernV1HomepageThreadlistResponseModel : TTResponseModel
{
    NSNumber *_err_no;
    long long _has_more;
