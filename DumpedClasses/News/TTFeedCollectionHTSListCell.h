...
@class NSString, TTCategory, TTHTSWaterfallCollectionView;

@interface TTFeedCollectionHTSListCell : TTFeedCollectionCell <ArticleBaseListViewDelegate>
{
    TTHTSWaterfallCollectionView *_listView;
    TTCategory *_category;
}

@property(retain, nonatomic) TTCategory *category; // @synthesize category=_category;
@property(retain, nonatomic) TTHTSWaterfallCollectionView *listView; // @synthesize listView=_listView;
- (void).cxx_destruct;
