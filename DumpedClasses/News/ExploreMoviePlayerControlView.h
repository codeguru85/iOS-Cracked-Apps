...
@class ExploreMovieMiniSliderView, ExploreMoviePlayerControlTipView, NSString, NSTimer, SSThemedLabel, TTAlphaThemedButton, TTImageView, TTMovieAdjustView, TTMovieBrightnessView, TTMoviePlayerControlBottomView, TTMoviePlayerControlFinishAction, TTMoviePlayerControlFinishAdAction, TTMoviePlayerControlLiveBottomView, TTMoviePlayerControlTopView, TTVideoTabThirdStyleTopView, UIImageView, UIPanGestureRecognizer, UISlider;

@interface ExploreMoviePlayerControlView : UIView <TTMoviePlayerControlSliderViewDelegate, TTPlayerControlView>
{
...
- (void)enablePrePlayBtn:(_Bool)arg1 isFromFinishAtion:(_Bool)arg2;
...
- (void)prePlayBtnClicked:(id)arg1;
