...
@interface TTVideoDetailADContainerView : TTDetailNatantViewBase <ExploreDetailBaseADViewDelegate, TTDetailNatantViewBase>
{
    _Bool _isVideoAd;
    _Bool _hasLogV2;
    NSArray *_adModels;
    Article *_article;
    id <TTVideoDetailADContainerViewDelegate> _delegate;
...
@property(nonatomic) __weak id <TTVideoDetailADContainerViewDelegate> delegate; // @synthesize delegate=_delegate;
