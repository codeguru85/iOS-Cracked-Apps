...
@class DetailActionRequestManager, NSArray, SSThemedButton, TTActionSheetController, TTAlphaThemedButton, TTAsyncCornerImageView, TTAsyncLabel, TTCommentReplyListView, TTDiggButton, TTUniversalCommentLayout, TTUserInfoView;
...
@interface TTUniversalCommentCellLite : SSThemedTableViewCell
{
    ...
    TTUniversalCommentLayout *_layout;
...
@property(retain, nonatomic) TTUniversalCommentLayout *layout; // @synthesize layout=_layout;
