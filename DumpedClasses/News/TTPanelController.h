...
@class NSArray, NSMutableArray, NSString, SSThemedButton, SSThemedView, TTPanelControllerWindow, TTPanelRootViewController;
...
@interface TTPanelController : NSObject
{
    ...
    TTPanelControllerWindow *_backWindow;
    TTPanelRootViewController *_rootViewController;
    NSArray *_data;
...
@property(retain, nonatomic) TTPanelRootViewController *rootViewController; // @synthesize rootViewController=_rootViewController;
@property(retain, nonatomic) TTPanelControllerWindow *backWindow; // @synthesize backWindow=_backWindow;
