...
@class Article, ArticleCommentView, ArticleMomentCommentManager, ArticleMomentCommentModel, ArticleMomentManager, ArticleMomentModel, FRPostCommonButton, FRThreadEntity, NSDictionary, NSString, SSActivityView, SSLoadMoreCell, SSNavigationBar, TTActivityShareManager, TTCommentDetailReplyCommentModel, TTGroupModel, Thread, UITableView;
...
- (void)p_replyCommentWithModel:(id)arg1;
