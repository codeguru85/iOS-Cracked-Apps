...
@class SSThemedLabel, SSThemedView, TTMovieNetTrafficViewModel, UIButton;

@interface TTMovieNetTrafficView : UIView
{
    CDUnknownBlockType _backBlock;
    CDUnknownBlockType _continuePlayBlock;
    TTMovieNetTrafficViewModel *_viewModel;
...
@property(retain, nonatomic) TTMovieNetTrafficViewModel *viewModel; // @synthesize viewModel=_viewModel;
