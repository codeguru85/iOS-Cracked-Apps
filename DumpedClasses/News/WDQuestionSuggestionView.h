...
@class NSString, SSThemedTableView, WDPostQuestionViewModel;

@interface WDQuestionSuggestionView : SSThemedView <UITableViewDelegate, UITableViewDataSource>
{
    id <WDQuestionSuggestionViewDelegate> _delegate;
...
@property(nonatomic) __weak id <WDQuestionSuggestionViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (id)suggestionArray;
