...
#import "TTADMoviePlayerControllerDelegate.h"
...
@class ExploreMovieManager, ExploreMovieViewModel, ExploreMovieViewTracker, ExploreOrderedData, ExploreVideoModel, NSDictionary, NSIndexPath, NSString, TTADPlayerController, TTAudioWaveView, TTGroupModel, TTMovieFullscreenViewController, TTMovieNetTrafficView, TTVideoRotateScreenController, TTVideoURLRequestInfo, UITableView, UIView;

@interface TTADMovieView : SSViewBase <SSMoviePlayerControllerDelegate, TTADMoviePlayerControllerDelegate, ExploreMovieManagerDelegate, SSMoviePlayerTrackManagerDelegate, UIViewControllerTransitioningDelegate, TTMovieFullscreenViewControllerDelegate, TTVideoRotateViewProtocol, TTMovieFullscreenProtocol>
{
    _Bool _enableRotate;
    ...
    id <TTADMovieViewDelegate> _movieViewDelegate;
    ExploreMovieViewTracker *_tracker;
    TTADPlayerController *_moviePlayerController;
...
+ (void)stopAllTTADMovieView;
+ (void)removeAllTTADMovieView;
...
@property(retain, nonatomic) TTADPlayerController *moviePlayerController; // @synthesize moviePlayerController=_moviePlayerController;
@property(retain, nonatomic) ExploreMovieViewTracker *tracker; // @synthesize tracker=_tracker;
@property(nonatomic) __weak id <TTADMovieViewDelegate> movieViewDelegate; // @synthesize movieViewDelegate=_movieViewDelegate;
