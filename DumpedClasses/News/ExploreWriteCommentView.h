...
@class ArticleReadQualityModel, ExploreSearchViewController, NSString, SSPGCActionManager, SSThemedButton, SSThemedLabel, SSThemedTextView, SSThemedView, TTGroupModel, UIView;

@interface ExploreWriteCommentView : SSViewBase <UITextViewDelegate, UIGestureRecognizerDelegate, SSPGCActionManagerDelegate>
{
    ...
    id <ExploreWriteCommentViewDelegate> _delegate;
    ArticleReadQualityModel *_readQuality;
...
@property(retain, nonatomic) ArticleReadQualityModel *readQuality; // @synthesize readQuality=_readQuality;
...
@property(nonatomic) __weak id <ExploreWriteCommentViewDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)didAppear;
- (void)willAppear;
- (void)previousFrame:(struct CGRect)arg1;
