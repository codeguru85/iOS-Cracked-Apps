...
@class ExploreMovieMiniSliderView, NSString, NSTimer, SSThemedLabel, TTAlphaThemedButton, TTChatroomMoviePlayerControlTipView, TTImageView, TTMovieAdjustView, TTMovieBrightnessView, TTMoviePlayerControlLiveBottomView, TTMoviePlayerControlTopView, UIPanGestureRecognizer, UISlider;

@interface TTChatroomMoviePlayerControlView : UIView <TTMoviePlayerControlSliderViewDelegate>
{
