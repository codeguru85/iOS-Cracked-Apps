...
@class AMapBusLineBaseSearchRequest, AMapBusLineSearchResponse, AMapBusStopSearchRequest, AMapBusStopSearchResponse, AMapDistrictSearchRequest, AMapDistrictSearchResponse, AMapGeocodeSearchRequest, AMapGeocodeSearchResponse, AMapInputTipsSearchRequest, AMapInputTipsSearchResponse, AMapNearbySearchRequest, AMapNearbySearchResponse, AMapPOISearchBaseRequest, AMapPOISearchResponse, AMapReGeocodeSearchRequest, AMapReGeocodeSearchResponse, AMapRouteSearchBaseRequest, AMapRouteSearchResponse, AMapWeatherSearchRequest, AMapWeatherSearchResponse, NSError;
