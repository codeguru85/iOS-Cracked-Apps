...
@class DetailActionRequestManager, NSArray, SSThemedButton, TTActionSheetController, TTAsyncCornerImageView, TTAsyncLabel, TTCommentReplyListView, TTDiggButton, TTNewCommentLayout, TTUserInfoView;

@interface TTNewCommentCellLite : SSThemedTableViewCell
{
    ...
    NSArray *_menuItems;
    TTNewCommentLayout *_layout;
}

+ (id)infoButtonStringWithModel:(id)arg1;
+ (double)widthForDescLabel:(double)arg1;
@property(retain, nonatomic) TTNewCommentLayout *layout; // @synthesize layout=_layout;
