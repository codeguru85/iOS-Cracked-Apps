...
@class ExploreFetchListManager, ExploreItemActionManager, NSString, NSTimer, UICollectionView;

@interface TTWaterfallCollectionView : ArticleBaseListView <UICollectionViewDataSource, CHTCollectionViewDelegateWaterfallLayout, SSImpressionProtocol, UIViewControllerErrorHandler>
{
    _Bool _isShowing;
...
- (void)openArticleByOrderedData:(id)arg1;
