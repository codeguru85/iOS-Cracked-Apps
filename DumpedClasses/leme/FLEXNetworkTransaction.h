...
@class NSData, NSDate, NSError, NSString, NSURLRequest, NSURLResponse, UIImage;
...
@property(retain, nonatomic) NSData *cachedRequestBody; // @synthesize cachedRequestBody=_cachedRequestBody;
