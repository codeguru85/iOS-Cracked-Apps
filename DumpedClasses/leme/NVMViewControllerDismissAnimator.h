...
@interface NVMViewControllerDismissAnimator : NSObject <UIViewControllerAnimatedTransitioning>
{
...
- (id)initWithTransitionType:(long long)arg1 duration:(double)arg2;
