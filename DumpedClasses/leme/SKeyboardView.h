...
@class KeyboadStack, NSMutableArray, NSString, PKeyboardCharactersView, PKeyboardNumbersView, PKeyboardSymbolsView, SKeyboardCharacterView, SKeyboardNumbersView, SKeyboardSymbolsView, UITextField;

@interface SKeyboardView : UIView
{
    UITextField *relativeTfd;
    SKeyboardCharacterView *charactersView;
    SKeyboardNumbersView *numbersView;
    SKeyboardSymbolsView *symbolsView;
    ...
    PKeyboardCharactersView *charactersViewWithNewLogin;
    PKeyboardNumbersView *numbersViewWithNewLogin;
    PKeyboardSymbolsView *symbolsViewWithNewLogin;
...
@property(retain, nonatomic) PKeyboardSymbolsView *symbolsViewWithNewLogin; // @synthesize symbolsViewWithNewLogin;
@property(retain, nonatomic) PKeyboardNumbersView *numbersViewWithNewLogin; // @synthesize numbersViewWithNewLogin;
@property(retain, nonatomic) PKeyboardCharactersView *charactersViewWithNewLogin; // @synthesize charactersViewWithNewLogin;
...
@property(retain, nonatomic) SKeyboardSymbolsView *symbolsView; // @synthesize symbolsView;
@property(retain, nonatomic) SKeyboardNumbersView *numbersView; // @synthesize numbersView;
@property(retain, nonatomic) SKeyboardCharacterView *charactersView; // @synthesize charactersView;
- (void).cxx_destruct;
- (void)dealloc;
- (void)unShift;
