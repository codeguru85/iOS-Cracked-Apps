...
@class GMSx_PBFieldOptions, NSString;

@interface GMSx_PBFieldDescriptorProto : GMSx_PBGeneratedMessage
{
}
...
@property(retain, nonatomic) GMSx_PBFieldOptions *options; // @dynamic options;
