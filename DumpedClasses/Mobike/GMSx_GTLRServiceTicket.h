...
@class GMSx_GTLRObject, GMSx_GTLRService, GMSx_GTMSessionFetcher, GMSx_GTMSessionFetcherService, NSDate, NSDictionary, NSError, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSString, NSURLRequest;
