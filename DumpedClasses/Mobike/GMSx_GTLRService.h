...
@class GMSx_GTMSessionFetcherService, NSArray, NSDictionary, NSObject<OS_dispatch_queue>, NSString;
...
+ (Class)ticketClass;
+ (id)GMSx_mockServiceWithFakedObject:(id)arg1 fakedError:(id)arg2;
...
- (id)init;
- (_Bool)GMSx_waitForTicket:(id)arg1 timeout:(double)arg2;
