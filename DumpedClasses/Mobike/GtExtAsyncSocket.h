...
@class GtExtAsyncReadPacket, GtExtAsyncSocketPreBuffer, GtExtAsyncWritePacket, NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>;

@interface GtExtAsyncSocket : NSObject
{
    unsigned int flags;
...
+ (id)gt_CRData;
+ (id)gt_CRLFData;
+ (_Bool)gt_getHost:(id *)arg1 port:(unsigned short *)arg2 fromAddress:(id)arg3;
+ (unsigned short)gt_portFromAddress:(id)arg1;
+ (id)gt_hostFromAddress:(id)arg1;
