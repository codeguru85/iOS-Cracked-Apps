...
@interface GTSSimplePing : NSObject
{
    ...
    double _spendTime;
    NSString *_hostName;
    id <GTSSimplePingDelegate> _delegate;
...
@property(nonatomic) __weak id <GTSSimplePingDelegate> delegate; // @synthesize delegate=_delegate;
