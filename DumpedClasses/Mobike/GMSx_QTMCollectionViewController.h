...
@class GMSx_QTMCollectionView, GMSx_QTMCollectionViewInfoBar, GMSx_QTMCollectionViewModel, GMSx_QTMInkTouchController, NSString, UICollectionViewLayout;

@interface GMSx_QTMCollectionViewController : UIViewController <QTMInkTouchControllerDelegate, GOOScrollViewKeyboardManagerDelegate, QTMCollectionViewModelDelegate, QTMCollectionViewInfoBarDelegate, QTMCollectionViewStyleDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate>
{
