...
@class GMSx_PBArray, GMSx_PBGeneratedMessage, NSData, NSString;

@protocol GMSx_PBMessageSignatureProtocol

@optional
+ (id)getClassValue;
- (id)mergeClass:(id)arg1;
- (id)setClassBuilder:(id)arg1;
- (id)setArray:(GMSx_PBArray *)arg1;
- (id)getArray;
- (int)getEnumAtIndex:(unsigned long long)arg1;
- (id)setEnum:(int)arg1;
- (int)getEnum;
- (GMSx_PBGeneratedMessage *)getGroupAtIndex:(unsigned long long)arg1;
- (id)setGroup:(GMSx_PBGeneratedMessage *)arg1;
- (GMSx_PBGeneratedMessage *)getGroup;
- (GMSx_PBGeneratedMessage *)getMessageAtIndex:(unsigned long long)arg1;
- (id)setMessage:(GMSx_PBGeneratedMessage *)arg1;
- (GMSx_PBGeneratedMessage *)getMessage;
