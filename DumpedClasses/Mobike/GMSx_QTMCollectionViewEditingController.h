...
@interface GMSx_QTMCollectionViewEditingController : NSObject <UIGestureRecognizerDelegate>
{
...
- (_Bool)shouldAutoscrollWithPanOffset:(double)arg1 inDirection:(long long)arg2;
- (long long)panDirectionWithGesture:(id)arg1;
