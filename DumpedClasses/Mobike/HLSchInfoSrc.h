...
@class HLCarriorInfoSrc, NSMutableDictionary, NSRecursiveLock;

@interface HLSchInfoSrc : NSObject
{
...
@property(retain) HLCarriorInfoSrc *carrior; // @synthesize carrior=_carrior;
- (void)dealloc;
- (id)init;
