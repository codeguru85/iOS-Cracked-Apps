...
@class GMSx_GTMSessionFetcherService, NSMutableDictionary, NSString, NSTimer, NSURLSession;

@interface GMSx_GTMSessionFetcherSessionDelegateDispatcher : NSObject <NSURLSessionDelegate>
{
    GMSx_GTMSessionFetcherService *_parentService;
