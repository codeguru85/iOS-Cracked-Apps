...
@class GMSx_GMPCAreaRenderOpGroup, GMSx_GMPCLabelRenderOpGroup, GMSx_GMPCLabelSpriteMap, GMSx_GMPCLineRenderOpGroup, GMSx_GMPCProviderTable, GMSx_GMPCRasterRenderOpGroup, GMSx_GMPCShaderRenderOpGroup, GMSx_GMPCTileOptions, GMSx_GMPCVolumeRenderOpGroup, GMSx_GMUTileCoordinateProto, GMSx_PBMutableArray;

@interface GMSx_GMPCClientVectorTile : GMSx_PBGeneratedMessage
{
}
...
@property(retain, nonatomic) GMSx_PBMutableArray *editArray; // @dynamic editArray;
...
@property(nonatomic) _Bool hasEditArray; // @dynamic hasEditArray;
@property(nonatomic) _Bool hasLabelGroup; // @dynamic hasLabelGroup;
@property(nonatomic) _Bool hasLayerEpochArray; // @dynamic hasLayerEpochArray;
@property(nonatomic) _Bool hasLineGroup; // @dynamic hasLineGroup;
@property(nonatomic) _Bool hasMajorEpoch; // @dynamic hasMajorEpoch;
@property(nonatomic) _Bool hasMultiZoomStyleTableArray; // @dynamic hasMultiZoomStyleTableArray;
...
@property(retain, nonatomic) GMSx_PBMutableArray *layerEpochArray; // @dynamic layerEpochArray;
...
@property(retain, nonatomic) GMSx_PBMutableArray *multiZoomStyleTableArray; // @dynamic multiZoomStyleTableArray;
