...
#import "GMSTileObserver.h"

@class GMSLRUCache, GMSStyleTableService, GMSTileCoordsTombstoneTracker, GMSTileRequestCoordinator, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSSet, NSString;
