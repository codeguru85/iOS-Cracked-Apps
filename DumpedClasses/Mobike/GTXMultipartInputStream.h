...
@interface GTXMultipartInputStream : NSInputStream
{
    NSString *_boundary;
...
- (void)_setCFClientFlags:(unsigned long long)arg1 callback:(CDUnknownFunctionPointerType)arg2 context:(CDStruct_4210025a)arg3;
