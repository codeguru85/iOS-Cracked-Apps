...
@interface GMSVectorMapSharedResources : NSObject
{
    ...
    reffed_ptr_b6b7b6c6 _buildingStencilState;
...
@property(readonly, nonatomic) reffed_ptr_b6b7b6c6 buildingStencilState; // @synthesize buildingStencilState=_buildingStencilState;
...
@property(readonly, nonatomic) reffed_ptr_7371fe81 routeDimTextureState; // @synthesize routeDimTextureState=_routeDimTextureState;
@property(readonly, nonatomic) reffed_ptr_7371fe81 routeTextureState; // @synthesize routeTextureState=_routeTextureState;
@property(readonly, nonatomic) reffed_ptr_7371fe81 roadArrowState; // @synthesize roadArrowState=_roadArrowState;
@property(readonly, nonatomic) reffed_ptr_7371fe81 roadTextureState; // @synthesize roadTextureState=_roadTextureState;
