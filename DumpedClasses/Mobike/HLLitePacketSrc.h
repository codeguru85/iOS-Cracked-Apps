...
@class HLCarriorInfoSrc, NSData, NSDate, NSDictionary, NSError, NSObject<OS_dispatch_queue>, NSString, NSURLSessionDataTask;

@interface HLLitePacketSrc : NSObject
{
    _Bool _banReport;
    _Bool _finish;
    _Bool _inCall;
...
@property(retain, nonatomic) HLCarriorInfoSrc *carrior; // @synthesize carrior=_carrior;
