...
@class GMSAnalytics, GMSForegroundDispatchQueue, GMSGLTileCoordsGenerator, GMSGLTileResources, GMSLRUCache, GMSTileCoordsTombstoneTracker, GMSTileRequestCoordinator, NSMutableDictionary, NSMutableSet;

@interface GMSGLTileProvider : NSObject
{
    _Bool _contributesLabels;
    GMSGLTileCoordsGenerator *_tileCoordsGenerator;
    ...
    id <GMSGLTileProviderConsumer> _consumer;
    ...
    CDUnknownBlockType _allTilesDeadBlock;
    unsigned long long _labelSourceDifferentiator;
    GMSAnalytics *_analytics;
}

+ (id)overlayImageTileProviderWithTileService:(id)arg1 tileCoordsGenerator:(id)arg2 requestCoordinator:(id)arg3 priority:(unsigned int)arg4 overdrawProtected:(_Bool)arg5;
+ (id)imageTileProviderWithTileService:(id)arg1 tileCoordsGenerator:(id)arg2 requestCoordinator:(id)arg3;
+ (id)hybridRoadsVectorTileProviderWithTileService:(id)arg1 styleTableService:(id)arg2 tileCoordsGenerator:(id)arg3 requestCoordinator:(id)arg4 contributesLabels:(_Bool)arg5 useLabelsOnly:(_Bool)arg6;
+ (id)overlayVectorTileProviderWithTileService:(id)arg1 styleTableService:(id)arg2 tileCoordsGenerator:(id)arg3 requestCoordinator:(id)arg4 contributesLabels:(_Bool)arg5;
+ (id)vectorTileProviderWithTileService:(id)arg1 styleTableService:(id)arg2 tileCoordsGenerator:(id)arg3 requestCoordinator:(id)arg4 contributesLabels:(_Bool)arg5;
...
@property(copy, nonatomic) CDUnknownBlockType allTilesDeadBlock; // @synthesize allTilesDeadBlock=_allTilesDeadBlock;
@property(readonly, nonatomic) __weak id <GMSGLTileProviderConsumer> consumer; // @synthesize consumer=_consumer;
...
@property(readonly, nonatomic) GMSGLTileCoordsGenerator *tileCoordsGenerator; // @synthesize tileCoordsGenerator=_tileCoordsGenerator;
...
- (void)addTileToGLTileCache:(id)arg1 diffTiles:(id)arg2 forCoords:(id)arg3 fromTileService:(id)arg4 wasPrefetch:(_Bool)arg5 willRefresh:(_Bool)arg6;
...
@property(nonatomic) _Bool blockNetworkFetches;
