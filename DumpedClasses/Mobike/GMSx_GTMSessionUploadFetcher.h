...
#import "GMSx_GTMSessionFetcher.h"

@class NSData, NSDictionary, NSFileHandle, NSObject<OS_dispatch_queue>, NSString, NSURL, NSURLRequest;

@interface GMSx_GTMSessionUploadFetcher : GMSx_GTMSessionFetcher
{
    GMSx_GTMSessionFetcher *_chunkFetcher;
    ...
    GMSx_GTMSessionFetcher *_fetcherInFlight;
...
- (_Bool)isFetching;
@property(readonly) GMSx_GTMSessionFetcher *activeFetcher; // @dynamic activeFetcher;
...
@property(retain) GMSx_GTMSessionFetcher *fetcherInFlight; // @dynamic fetcherInFlight;
@property(retain) GMSx_GTMSessionFetcher *chunkFetcher; // @synthesize chunkFetcher=_chunkFetcher;
