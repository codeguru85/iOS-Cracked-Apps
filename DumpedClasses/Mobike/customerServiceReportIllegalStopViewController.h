...
@interface customerServiceReportIllegalStopViewController : Mobike_ViewController <UITextViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    UIButton *report;
    UILabel *scanNote;
    UILabel *bikeCode;
