...
#import "GMSTouchMonitorDelegate.h"
#import "UIGestureRecognizerDelegate.h"
#import "UIScrollViewDelegate.h"

@class GMSDeceleratedValue, GMSPanGestureRecognizer, GMSTiltGestureRecognizer, GMSTouchMonitor, NSMutableSet, NSSet, NSString, NSTimer, UILongPressGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
- (id)initWithFrame:(struct CGRect)arg1 displayLink:(id)arg2 offscreenSink:(id)arg3 gestures:(unsigned int)arg4 recognizerSource:(id)arg5;
