...
#import "GMSx_GTLRRuntimeCommon.h"
#import "GTLRQueryProtocol.h"
#import "NSCopying.h"

@class GMSx_GTLRObject, GMSx_GTLRServiceExecutionParameters, GMSx_GTLRUploadParameters, NSArray, NSDictionary, NSMutableDictionary, NSString;

@interface GMSx_GTLRQuery : NSObject <GMSx_GTLRRuntimeCommon, GTLRQueryProtocol, NSCopying>
{
    ...
    GMSx_GTLRUploadParameters *_uploadParameters;
}
...
@property(copy) GMSx_GTLRUploadParameters *uploadParameters; // @synthesize uploadParameters=_uploadParameters;
...
@property(retain) GMSx_GTLRObject *bodyObject; // @synthesize bodyObject=_bodyObject;
