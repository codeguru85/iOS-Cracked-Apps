...
@class GMSx_PBMethodOptions, NSString;

@interface GMSx_PBMethodDescriptorProto : GMSx_PBGeneratedMessage
{
}
...
@property(retain, nonatomic) GMSx_PBMethodOptions *options; // @dynamic options;
