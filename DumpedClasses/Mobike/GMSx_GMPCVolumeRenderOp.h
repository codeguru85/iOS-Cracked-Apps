...
@class GMSx_GMPCStripifiedMesh, GMSx_PBMutableArray;

@interface GMSx_GMPCVolumeRenderOp : GMSx_PBGeneratedMessage
{
}
...
@property(retain, nonatomic) GMSx_PBMutableArray *extrudedAreaArray; // @dynamic extrudedAreaArray;
@property(nonatomic) _Bool hasBaseTileOpId; // @dynamic hasBaseTileOpId;
@property(nonatomic) _Bool hasExtrudedAreaArray; // @dynamic hasExtrudedAreaArray;
