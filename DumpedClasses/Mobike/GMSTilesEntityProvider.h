...
#import "GMSFeatureEntityUIItemDelegate.h"
#import "GMSGLTileProviderConsumer.h"

@class GMSAnalytics, GMSCoreClientParameters, GMSGLIndoorVectorTileProvider, GMSGLTileProvider, GMSGLTileResources, GMSIndoorBuilding, GMSIndoorState, GMSLabelsEntityProvider, GMSServerResourceManager, GMSStyleTableService, GMSTileRequestCoordinator, GMSTileType, GMSVectorMapView, NSLock, NSMutableArray, NSString, NSThread;
...
@interface GMSTilesEntityProvider : NSObject <GMSGLTileProviderConsumer, GMSFeatureEntityUIItemDelegate, GMSEntityProvider>
{
    ...
    set_ce9d08b8 _tileTapItems;
    set_ce9d08b8 _labelTapItems;
    int _labelDrawMode;
...
- (void)updateTappableItemsWithNewItems:(set_ce9d08b8 *)arg1 existingItems:(set_ce9d08b8 *)arg2;
- (void)removeItemsInTappableItems:(const set_ce9d08b8 *)arg1;
- (void)addItemsInTappableItems:(const set_ce9d08b8 *)arg1;
