...
@class NSArray, NSError, NSString, QAnnotationView, QMapView, QOverlayView, QPointAnnotation, QUserLocation, UIControl;
...
- (void)mapView:(QMapView *)arg1 didChangeUserTrackingMode:(unsigned long long)arg2 animated:(_Bool)arg3;
...
- (void)mapView:(QMapView *)arg1 didUpdateUserLocation:(QUserLocation *)arg2 sender:(_Bool)arg3;
