...
@interface TencentLBSLiteLocationUtils : NSObject
{
}

+ (struct CLLocationCoordinate2D)WGS84TOGCJ02:(struct CLLocationCoordinate2D)arg1;
+ (_Bool)isInRegionWithLatitude:(double)arg1 longitude:(double)arg2;
+ (double)distanceBetweenTwoTencentLBSLiteLocations:(id)arg1 locationTwo:(id)arg2;
