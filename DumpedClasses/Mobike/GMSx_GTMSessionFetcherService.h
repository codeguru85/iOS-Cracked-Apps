...
@class GMSx_GTMSessionFetcherSessionDelegateDispatcher, NSArray, NSDate, NSDictionary, NSHTTPCookieStorage, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSOperationQueue, NSString, NSURLCredential, NSURLSessionConfiguration;
