...
@class MBKUnLockApi, NSString;

@interface MBKUnLockManager : NSObject <MBKDataProviderDelegate, MBKDataProviderProtocol>
{
...
@property(retain, nonatomic) MBKUnLockApi *api; // @synthesize api=_api;
