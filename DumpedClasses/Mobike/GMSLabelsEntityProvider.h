...
@property(nonatomic) int labelDrawMode; // @synthesize labelDrawMode=_labelDrawMode;
...
- (void)removeLabelableFeatures:(const vector_a9c0dc88 *)arg1;
- (void)removeLabelableFeatures:(const vector_a9c0dc88 *)arg1 category:(int)arg2;
- (void)addLabelableFeatures:(const vector_a9c0dc88 *)arg1;
- (void)addLabelableFeatures:(const vector_a9c0dc88 *)arg1 category:(int)arg2;
