...
@interface customerServiceCannotLockViewController : Mobike_ViewController <UITextViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate>
{
    UIButton *report;
    UIButton *makePhoto;
