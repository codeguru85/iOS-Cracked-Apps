...
@class GMSCacheStorageDescriptor, GMSReservations, NSManagedObjectContext, NSMutableDictionary, NSMutableOrderedSet, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSString;
...
@interface GMSTileDataCache : NSObject <GMSTileDataCache>
{
    ...
    _Bool _areReservationsInitialized;
