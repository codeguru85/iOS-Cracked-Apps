...
@class GMSx_QTMCollectionView, GMSx_QTMColorGroup, NSMutableArray, NSMutableDictionary, NSMutableSet, UIColor;
...
@interface GMSx_QTMCollectionViewStyleController : NSObject
{
    ...
    GMSx_QTMColorGroup *_collectionViewBackgroundColorGroup;
...
@property(retain, nonatomic) GMSx_QTMColorGroup *collectionViewBackgroundColorGroup; // @synthesize collectionViewBackgroundColorGroup=_collectionViewBackgroundColorGroup;
