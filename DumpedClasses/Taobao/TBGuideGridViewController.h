...
@class TBGuidePhotoBrowser;

@interface TBGuideGridViewController : UICollectionViewController
{
    double _margin;
    double _gutter;
    double _marginL;
...
@property(nonatomic) TBGuidePhotoBrowser *browser; // @synthesize browser=_browser;
