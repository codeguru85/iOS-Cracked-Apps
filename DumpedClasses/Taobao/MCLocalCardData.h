...
#import "MCLocalCardDataProtocol.h"

@class NSString;

@interface MCLocalCardData : NSObject <MCLocalCardDataProtocol>
{
    NSString *_innerTitle;
    NSString *_innerImageUrl;
    NSString *_innerContent;
    NSString *_innerLocation;
    NSString *_innerOpenUrl;
}

@property(retain, nonatomic) NSString *innerOpenUrl; // @synthesize innerOpenUrl=_innerOpenUrl;
@property(retain, nonatomic) NSString *innerLocation; // @synthesize innerLocation=_innerLocation;
