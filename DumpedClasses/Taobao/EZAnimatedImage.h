...
@class EZTextureImage, NSData, NSDictionary, NSIndexSet, NSMutableDictionary, NSMutableIndexSet, NSObject<OS_dispatch_queue>;

@interface EZAnimatedImage : NSObject
{
    _Bool _predrawingEnabled;
    EZTextureImage *_posterImage;
...
@property(readonly, nonatomic) EZAnimatedImage *weakProxy; // @synthesize weakProxy=_weakProxy;
...
@property(readonly, nonatomic) EZTextureImage *posterImage; // @synthesize posterImage=_posterImage;
- (void).cxx_destruct;
- (id)description;
