...
@class TBSearchIconViewComponent, TBSearchImageView, TBSearchPriceLabel, TBSearchPropTagView, TBSearchSpuItem, TBTextAttachment, TBTextLabel, UIButton, UIImageView, UILabel, UIView;

@interface TBSearchSpuCell : TBSearchBaseCell
{
    TBSearchSpuItem *_model;
    ...
    UIImageView *_theNewProductIconImageView;
