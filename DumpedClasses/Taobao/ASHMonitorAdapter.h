...
@interface ASHMonitorAdapter : ASHAdapterBase <ASHMonitorProtocol>
{
    id <ASHMonitorProtocol> _imp;
}

+ (id)sharedInstance;
@property(retain, nonatomic) id <ASHMonitorProtocol> imp; // @synthesize imp=_imp;
- (void).cxx_destruct;
