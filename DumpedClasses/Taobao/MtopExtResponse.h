...
@class Error, MtopExtRequest, NSData, NSDictionary, NSMutableDictionary, NSString, NSURL, TBJSONModel;
...
@property(retain, nonatomic) TBJSONModel *dsResponseJSONModel;
@property(retain, nonatomic) TBJSONModel *tbcResponseModel;
@property(retain, nonatomic) TBJSONModel *responseJSONModel;
