...
@interface MCOfficialMarketingDataProcessor : MCOfficialBaseProcessor <MCOfficialBubbleDelegate>
{
}

- (void)bubble:(id)arg1 didSelectedIndex:(long long)arg2 withMessageVO:(id)arg3;
