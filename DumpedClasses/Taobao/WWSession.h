...
@class LastMsgInfo, NSDate, NSNumber, NSSet, NSString, PluginMessages, WWMessage;
...
@property(retain, nonatomic) NSDate *draftUpdateTime; // @dynamic draftUpdateTime;
...
@property(retain, nonatomic) PluginMessages *lastPluginMessage; // @dynamic lastPluginMessage;
...
@property(retain, nonatomic) NSDate *orderTime; // @dynamic orderTime;
...
@property(retain, nonatomic) NSNumber *unreadAtAllCount; // @dynamic unreadAtAllCount;
@property(retain, nonatomic) NSNumber *unreadAtMeCount; // @dynamic unreadAtMeCount;
