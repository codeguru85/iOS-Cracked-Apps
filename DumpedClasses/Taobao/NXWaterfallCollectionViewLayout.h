...
@interface NXWaterfallCollectionViewLayout : UICollectionViewLayout
{
...
- (_Bool)hasSectionHeader;
- (id)layoutAttributesForSupplementaryViewOfKind:(id)arg1 atIndexPath:(id)arg2;
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;
- (struct CGSize)collectionViewContentSize;
- (struct CGSize)headerSizeForSection:(unsigned long long)arg1;
- (double)_widthForSection:(unsigned long long)arg1;
