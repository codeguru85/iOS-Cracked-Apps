...
@interface TMMarketHotMarketHorizontalComponent : TMMarketBaseComponent
{
    _Bool _hot;
    _Bool _useflare;
    NSString *_title;
...
@property(copy, nonatomic) NSString *cornerTagString; // @synthesize cornerTagString=_cornerTagString;
