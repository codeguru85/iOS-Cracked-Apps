...
@class NSString, TBRateAppendOrderRateInfoComponent, TBRateEditPhotoGuidView, TBRateImageUploadView, TBRateVoiceInputView, UILabel, UITextView;

@interface TBRateAppendOrderRateView : UIView <UITextFieldDelegate, UITextViewDelegate, TBRateImageUploadProtocol, TBRateVoiceInputViewDelegate>
{
