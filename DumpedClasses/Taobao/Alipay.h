...
@property(copy, nonatomic) NSDictionary *insideEnv; // @synthesize insideEnv;
...
@property(copy, nonatomic) NSString *backSchemeString;
- (void)preLoad;
...
@property(nonatomic) _Bool doNotCallback;
