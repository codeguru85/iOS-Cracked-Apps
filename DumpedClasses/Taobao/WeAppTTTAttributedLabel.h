...
@interface WeAppTTTAttributedLabel : UILabel <WeAppTTTAttributedLabel, UIGestureRecognizerDelegate>
{
    ...
    id <WeAppTTTAttributedLabelDelegate> _delegate;
...
@property(nonatomic) id <WeAppTTTAttributedLabelDelegate> delegate; // @synthesize delegate=_delegate;
