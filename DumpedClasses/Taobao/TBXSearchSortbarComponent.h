...
#import "TBXSearchSortbarItemDelegate.h"
...
{
    _Bool _hasLoadView;
    TBXSearchSortbarViewModel *_viewModel;
    UIView *_sortbarParentView;
    UIView *_hostView;
    id <TBXSearchSortbarComponentDelegate> _sortbarComponentDelegate;
    NSMutableArray *_sortCollection;
