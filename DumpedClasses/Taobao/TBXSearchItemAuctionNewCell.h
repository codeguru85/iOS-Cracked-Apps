...
@class NSArray, NSString, TBSearchIconViewComponent, TBSearchImageView, TBSearchItemCellShopInfoView, TBSearchPriceLabel, TBSearchTitleView, TBSearchWapItem, TBXSearchItemCellLongPressManager, TBXSearchItemCellMaskBase, UIButton, UIImageView, UILabel, UIView;
...
@property(retain, nonatomic) UILabel *summaryTipsLabel; // @synthesize summaryTipsLabel=_summaryTipsLabel;
