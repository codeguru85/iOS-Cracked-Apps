...
@interface ACDSConnection : NSOperation <NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSCopying>
{
    ...
    id <ACDSConnectionDelegate> _delegate;
...
@property(nonatomic) __weak id <ACDSConnectionDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (_Bool)isConcurrent;
- (_Bool)isReady;
- (void)start;
