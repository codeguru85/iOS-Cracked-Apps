...
@class NSArray, NSString, TBSearchIconViewComponent, TBSearchImageView, TBSearchPriceLabel, TBSearchTitleView, TBSearchWapItem, TBXSearchItemCellMaskBase, UIButton, UIImageView, UILabel, UIView;

@interface TBXSearchItemCellBase : TBSearchBaseCell <TBSearchItemCellMaskDelegate, UIGestureRecognizerDelegate>
{
