...
- (id)init;
- (void)tryReportInfoWithAPIName:(id)arg1 APIVersion:(id)arg2 bizParams:(id)arg3;
- (void)tryReportInfoForRequest:(id)arg1;
- (id)sync_call:(id)arg1 apiVersion:(id)arg2 bizParameters:(id)arg3 withMonitoringID:(id)arg4;
- (id)sync_call:(id)arg1 apiVersion:(id)arg2 withMonitoringID:(id)arg3;
- (void)async_call:(id)arg1 delegate:(id)arg2 startFilter:(id)arg3 withMonitoringID:(id)arg4;
- (void)async_call:(id)arg1 delegate:(id)arg2 withMonitoringID:(id)arg3;
- (id)sync_call:(id)arg1 withMonitoringID:(id)arg2;
