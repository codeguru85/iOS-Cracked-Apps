...
@class ASRIOConsumerPool, NSArray, NSDate, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSObject<OS_dispatch_queue>, NSOperationQueue, NSOutputStream, NSString, NSTimer, NSURL, NSURLRequest;
...
@interface ASRWebSocket : NSObject <NSStreamDelegate>
{
    ...
    ASRWebSocket *_selfRetain;
    NSArray *_requestedProtocols;
    ASRIOConsumerPool *_consumerPool;
    NSTimer *_statusTimer;
    NSDate *_lastActivityDate;
    int _readyState;
    id <ASRWebSocketDelegate> _delegate;
    NSURL *_url;
    NSString *_protocol;
}
