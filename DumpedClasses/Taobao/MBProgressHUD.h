...
+ (id)hp_showAndAutoHideHUDAddedTo:(id)arg1 text:(id)arg2 animated:(_Bool)arg3;
+ (id)hp_showHUDAddedTo:(id)arg1 duration:(double)arg2 text:(id)arg3 animated:(_Bool)arg4;
