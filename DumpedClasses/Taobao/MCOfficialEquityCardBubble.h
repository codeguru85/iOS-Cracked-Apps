...
@interface MCOfficialEquityCardBubble : MCOfficialBaseBubble <MCChatBubbleBackgroundViewDelegate>
{
    MCChatBubbleBackgroundView *_innerBubbleImageView;
    UILabel *_titleLabel;
    UIImageView *_contentImageView;
    UILabel *_cardNameLabel;
    UILabel *_cardIconLabel;
}

+ (id)subStyle;
+ (struct CGSize)bubbleSizeWithMessageVO:(id)arg1;
@property(retain, nonatomic) UILabel *cardIconLabel; // @synthesize cardIconLabel=_cardIconLabel;
