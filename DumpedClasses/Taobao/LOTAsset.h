...
@class LOTLayerGroup, NSNumber, NSString, UIImage;
...
- (void).cxx_destruct;
- (void)_mapFromJSON:(id)arg1 withBounds:(struct CGRect)arg2 withFramerate:(id)arg3 withAssetGroup:(id)arg4;
- (id)initWithJSON:(id)arg1 withBounds:(struct CGRect)arg2 withFramerate:(id)arg3 withAssetGroup:(id)arg4;
