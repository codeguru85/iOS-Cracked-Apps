...
@class MBProgressHUD, MPMoviePlayerViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSTimer, TBGuideGridViewController, UIActivityIndicatorView, UIActivityViewController, UIBarButtonItem, UIColor, UIImage, UIScrollView, UIToolbar;

@interface TBGuidePhotoBrowser : UIViewController <UIScrollViewDelegate, UIActionSheetDelegate>
{
    ...
    TBGuideGridViewController *_gridController;
    ...
    id <TBGuidePhotoBrowserDelegate> _delegate;
...
@property(nonatomic) __weak id <TBGuidePhotoBrowserDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
