...
@class NSString, UIFont, WeAppBasicTextView;

@interface WeAppTextViewComponent : WeAppComponent <UITextViewDelegate>
{
    _Bool _needBeginEditing;
    _Bool _needChange;
    _Bool _needEndEditing;
    _Bool _needEndEditingAndChange;
    WeAppBasicTextView *_textView;
...
@property(retain, nonatomic) WeAppBasicTextView *textView; // @synthesize textView=_textView;
- (void).cxx_destruct;
