...
{
    _Bool _isFrontCommonAddress;
    _Bool _hasCommonAddress;
    _Bool _refreshed;
    UIScrollView *_pagesView;
    UIScrollView *_containerViewFull;
    UIView *_containerCommonView;
    UIView *_containerView;
    UIActivityIndicatorView *_loadingIndicator;
    AliDetailAreaChooseHeaderView *_headerView;
    AliDetailAreaTitleView *_titleView;
    AliDetailAreaItemPage *_commonAddressView;
    AliTradeDetailAreaListService *_areaService;
    AliDetailServiceContext *_areaContext;
    NSMutableArray *_itemPages;
    NSMutableArray *_headerSource;
