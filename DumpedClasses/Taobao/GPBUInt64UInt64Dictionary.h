...
+ (id)dictionaryWithValues:(const unsigned long long *)arg1 forKeys:(const unsigned long long *)arg2 count:(unsigned long long)arg3;
...
- (_Bool)valueForKey:(unsigned long long)arg1 value:(unsigned long long *)arg2;
...
- (id)initWithValues:(const unsigned long long *)arg1 forKeys:(const unsigned long long *)arg2 count:(unsigned long long)arg3;
- (id)init;
