...
+ (id)dictionaryWithValues:(const float *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
...
- (_Bool)valueForKey:(id)arg1 value:(float *)arg2;
...
- (id)initWithValues:(const float *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
- (id)init;
