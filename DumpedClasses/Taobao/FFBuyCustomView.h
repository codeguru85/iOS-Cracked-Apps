...
#import "TBBuyTableViewAdapterProtocol.h"
#import "UITableViewDataSource.h"
#import "UITableViewDelegate.h"

@class NSDictionary, NSMutableArray, NSString, TBBuyKit;

@interface FFBuyCustomView : NSObject <UITableViewDelegate, UITableViewDataSource, TBBuyTableViewAdapterProtocol>
{
...
- (Class)_cellClassForModel:(id)arg1;
