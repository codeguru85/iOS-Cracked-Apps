...
#import "TBHLScrollViewDelegate.h"
#import "UIGestureRecognizerDelegate.h"
#import "UIScrollViewDelegate.h"

@class NSArray, NSMutableDictionary, NSMutableSet, NSString, NSTimer, UIScrollView;

@interface TBHLSwipeView : UIView <UIScrollViewDelegate, UIGestureRecognizerDelegate, TBHLScrollViewDelegate>
{
    ...
    _Bool _vertical;
    _Bool _allowSuperScrollOnThisView;
    _Bool _suppressScrollEvent;
    float _decelerationRate;
    id <TBHLSwipeViewDataSource> _dataSource;
    id <TBHLSwipeViewDelegate> _delegate;
...
@property(nonatomic) _Bool allowSuperScrollOnThisView; // @synthesize allowSuperScrollOnThisView=_allowSuperScrollOnThisView;
@property(nonatomic) double paddingBeforeAndAfter; // @synthesize paddingBeforeAndAfter=_paddingBeforeAndAfter;
...
@property(nonatomic) __weak id <TBHLSwipeViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) __weak id <TBHLSwipeViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
- (_Bool)allowSuperViewScroll;
