...
+ (id)dictionaryWithValues:(const long long *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(long long)arg1 forKey:(id)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(id)arg1;
- (void)setValue:(long long)arg1 forKey:(id)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (_Bool)valueForKey:(id)arg1 value:(long long *)arg2;
...
- (id)initWithValues:(const long long *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
- (id)init;
