...
@interface XPondInfo : NSObject
{
    unsigned long long _Pid;
    unsigned long long _AdminUid;
...
@property(retain) NSString *PondName; // @synthesize PondName=_PondName;
@property unsigned long long Sid; // @synthesize Sid=_Sid;
@property unsigned long long AdminUid; // @synthesize AdminUid=_AdminUid;
