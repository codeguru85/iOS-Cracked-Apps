...
+ (id)dictionaryWithValues:(const unsigned int *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(unsigned int)arg1 forKey:(id)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(id)arg1;
- (void)setValue:(unsigned int)arg1 forKey:(id)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (_Bool)valueForKey:(id)arg1 value:(unsigned int *)arg2;
...
- (id)initWithValues:(const unsigned int *)arg1 forKeys:(id *)arg2 count:(unsigned long long)arg3;
- (id)init;
