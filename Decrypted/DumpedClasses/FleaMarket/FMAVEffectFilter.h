...
@class FMAVEffectFramebuffer, FMAVEffectGLProgram, NSMutableDictionary, NSString;

@interface FMAVEffectFilter : FMAVEffectOutput <FMAVEffectInput>
{
    FMAVEffectFramebuffer *firstInputFramebuffer;
    FMAVEffectGLProgram *filterProgram;
