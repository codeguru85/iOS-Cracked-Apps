...
@class HPTextViewInternal, NSAttributedString, NSObject<HPGrowingTextViewDelegate>, NSString, UIColor, UIFont, UITextView;
...
@interface HPGrowingTextView : UIView <UITextViewDelegate>
{
    ...
    _Bool _disableReturnResignFirstResponder;
    UIFont *font;
    UIColor *textColor;
    double _lineHeightMultiple;
}

@property(nonatomic) _Bool disableReturnResignFirstResponder; // @synthesize disableReturnResignFirstResponder=_disableReturnResignFirstResponder;
...
- (void)addEmojiAttachment:(id)arg1 String:(id)arg2;
- (void)addEmoji:(id)arg1;
- (void)triggerDeleteAttrText;
- (id)getPlainText;
