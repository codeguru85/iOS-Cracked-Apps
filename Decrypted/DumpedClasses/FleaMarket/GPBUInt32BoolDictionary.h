...
+ (id)dictionaryWithValues:(const _Bool *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(_Bool)arg1 forKey:(unsigned int)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(unsigned int)arg1;
- (void)setValue:(_Bool)arg1 forKey:(unsigned int)arg2;
- (void)addEntriesFromDictionary:(id)arg1;
- (_Bool)valueForKey:(unsigned int)arg1 value:(_Bool *)arg2;
...
- (id)initWithValues:(const _Bool *)arg1 forKeys:(const unsigned int *)arg2 count:(unsigned long long)arg3;
- (id)init;
