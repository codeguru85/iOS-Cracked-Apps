...
- (id)fetchFramebufferForSize:(struct CGSize)arg1 textureOptions:(struct VSTextureOptions)arg2 onlyTexture:(_Bool)arg3;
- (id)hashForSize:(struct CGSize)arg1 textureOptions:(struct VSTextureOptions)arg2 onlyTexture:(_Bool)arg3;
- (void)dealloc;
- (id)init;
