...
@interface FMPostRentInputStringComponent : FMCellComponent <FMCardParserProtocol, FMWantRentPropertyValueProtocol, NSCopying>
{
    FMCategoryDO *categoryDO;
    FMCardDataInputStringDO *_inputStringDO;
}

@property(retain, nonatomic) FMCardDataInputStringDO *inputStringDO; // @synthesize inputStringDO=_inputStringDO;
