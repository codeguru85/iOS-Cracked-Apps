...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, XAdAFHTTPBodyPart;

@interface XAdAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    XAdAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) XAdAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
