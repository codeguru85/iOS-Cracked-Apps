...
@class NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSURL, NSURLCredential, XAdAFHTTPRequestSerializer<XAdAFURLRequestSerialization>, XAdAFHTTPResponseSerializer<XAdAFURLResponseSerialization>, XAdAFNetworkReachabilityManager, XAdAFSecurityPolicy;

@interface XAdAFHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    _Bool _shouldUseCredentialStorage;
    NSURL *_baseURL;
    XAdAFHTTPRequestSerializer<XAdAFURLRequestSerialization> *_requestSerializer;
    XAdAFHTTPResponseSerializer<XAdAFURLResponseSerialization> *_responseSerializer;
    NSOperationQueue *_operationQueue;
    NSURLCredential *_credential;
    XAdAFSecurityPolicy *_securityPolicy;
    XAdAFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) XAdAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) XAdAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
...
@property(retain, nonatomic) XAdAFHTTPResponseSerializer<XAdAFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) XAdAFHTTPRequestSerializer<XAdAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
