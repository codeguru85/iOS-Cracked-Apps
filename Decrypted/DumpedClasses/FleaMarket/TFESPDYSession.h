...
{
    TFESPDYConfiguration *_configuration;
    TFESPDYFrameDecoder *_frameDecoder;
    TFESPDYFrameEncoder *_frameEncoder;
    TFESPDYStreamManager *_activeStreams;
    TFESPDYStreamManager *_inactiveStreams;
    TFESPDYSocket *_socket;
    NSMutableData *_inputBuffer;
    unsigned int _lastGoodStreamId;
    unsigned int _nextStreamId;
    double _lastSocketActivity;
    double _sessionPingOut;
