...
@class NSURL, XAdAFHTTPRequestSerializer<XAdAFURLRequestSerialization>, XAdAFHTTPResponseSerializer<XAdAFURLResponseSerialization>;
...
@property(retain, nonatomic) XAdAFHTTPResponseSerializer<XAdAFURLResponseSerialization> *responseSerializer;
