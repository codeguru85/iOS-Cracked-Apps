...
@interface VSImageFilter : VSImageOutput <VSImageInput>
{
    ...
    VSImageGLProgram *filterProgram;
...
- (void)setVec4:(struct VSVector4)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setVec3:(struct VSVector3)arg1 forUniform:(int)arg2 program:(id)arg3;
...
- (void)setMatrix4f:(struct VSMatrix4x4)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setMatrix3f:(struct VSMatrix3x3)arg1 forUniform:(int)arg2 program:(id)arg3;
- (void)setFloatArray:(float *)arg1 length:(int)arg2 forUniform:(id)arg3;
- (void)setFloatVec4:(struct VSVector4)arg1 forUniform:(id)arg2;
- (void)setFloatVec3:(struct VSVector3)arg1 forUniformName:(id)arg2;
